...
var _RapierDebugRenderer_instances, _RapierDebugRenderer_free;
/**
...
export class RapierDebugRenderer {
    constructor(scene, world, options = {}) {
        _RapierDebugRenderer_instances.add(this);
        this.scene = scene;
        this.world = world;
    ...
    update() {
        ...
        if (!vertices || vertices.length === 0) {
            this.mesh.visible = false;
            __classPrivateFieldGet(this, _RapierDebugRenderer_instances, "m", _RapierDebugRenderer_free).call(this, buffers);
            return;
        }
...
_RapierDebugRenderer_instances = new WeakSet(), _RapierDebugRenderer_free = function _RapierDebugRenderer_free(buffers) {
