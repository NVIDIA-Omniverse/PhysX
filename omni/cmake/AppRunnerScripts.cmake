...
function(ovexts_define_app APP_NAME)
    ...
    if(WIN32)
        ...
        string(APPEND _CONTENT "\"%~dp0kit\\kit.exe\" \"%~dp0apps\\${APP_NAME}\" ${ARG_EXTRA_ARGS} %*\r\n")
        ...
        string(APPEND _CONTENT "\${EXEC:-exec} \"\$SCRIPT_DIR/kit/kit\" \"\$SCRIPT_DIR/apps/${APP_NAME}\" ${ARG_EXTRA_ARGS} \"\$@\"\n")
    ...
    if(CMAKE_GENERATOR MATCHES "Visual Studio")
        ...
        set_target_properties(${_TARGET_NAME} PROPERTIES
            ...
            VS_DEBUGGER_COMMAND_ARGUMENTS "\"${OVEXTS_BIN_DIR}/apps/${APP_NAME}\" ${ARG_EXTRA_ARGS}"
