...
class BaseVolumeDeformableBodyView : public omni::physics::tensors::IDeformableBodyView
{
public:
    BaseVolumeDeformableBodyView(BaseSimulationView* sim, const std::vector<DeformableBodyEntry>& entries);

    virtual ~BaseVolumeDeformableBodyView() override;
...
protected:
    ...
    uint32_t mMaxCollElementsPerBody;
    uint32_t mMaxSimElementsPerBody;
    uint32_t mMaxCollNodesPerBody;
