...
CpuParticleSystemView::CpuParticleSystemView(CpuSimulationView* sim, const std::vector<ParticleSystemEntry>& entries)
    : BaseParticleSystemView(sim, entries) { }

CpuParticleSystemView::~CpuParticleSystemView() { }
