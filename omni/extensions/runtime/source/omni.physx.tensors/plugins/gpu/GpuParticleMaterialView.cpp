...
GpuParticleMaterialView::GpuParticleMaterialView(GpuSimulationView* sim, const std::vector<ParticleMaterialEntry>& entries)
    : BaseParticleMaterialView(sim, entries) { }

GpuParticleMaterialView::~GpuParticleMaterialView() { }
