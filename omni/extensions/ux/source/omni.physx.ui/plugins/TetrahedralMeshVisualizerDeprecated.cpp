...
static const float gGapDefault = 0.2f;
...
GfVec4f precomputeTargetShrinkPointInnerTet(const VtVec3fArray& originalPoints, const uint32_t* indices)
{
    ...
    const GfVec3f point3 = originalPoints[indices[2]];
...
TetrahedralMeshVisualizerDeprecated::TetrahedralMeshVisualizerDeprecated(const SdfPath tetPath) :
    mTetPath(tetPath), mGap(gGapDefault)
{
}

TetrahedralMeshVisualizerDeprecated::~TetrahedralMeshVisualizerDeprecated()
{
}

void TetrahedralMeshVisualizerDeprecated::setTetPoints(const VtArray<GfVec3f>& originalPoints)
{
    mOriginalPoints = originalPoints;
}

void TetrahedralMeshVisualizerDeprecated::setTetIndices(const VtArray<int>& indices)
{
    mOriginalIndices = indices;
}

void TetrahedralMeshVisualizerDeprecated::setGapValue(const float gap)
{
...
void TetrahedralMeshVisualizerDeprecated::setTetColors(const VtArray<GfVec3f>& colors)
{
...
void TetrahedralMeshVisualizerDeprecated::updateTetTopology()
{
...
void TetrahedralMeshVisualizerDeprecated::updateTetPoints()
{
    if (!mTargetShrinkPointsBarycentric.empty())
        updateTetPointsInternal();
}

void TetrahedralMeshVisualizerDeprecated::computeRenderMeshPointsWithoutGap(const VtVec3fArray& originalPoints,
...
void TetrahedralMeshVisualizerDeprecated::computeRenderMeshPointsGap(const VtVec3fArray& originalPoints,
    const float gap,
    VtVec3fArray& newPoints)
{
...
void TetrahedralMeshVisualizerDeprecated::computeRenderMeshTopologyWithoutGap(VtIntArray& faceVertexCounts,
    VtIntArray& faceVertexIndices)
{
    const size_t numSurfaceTriangles = mSurfaceTriangles.size() / 3;
...
void TetrahedralMeshVisualizerDeprecated::computeRenderMeshTopologyGap(VtIntArray& faceVertexCounts,
    VtIntArray& faceVertexIndices)
{
    const size_t numIndices = mOriginalIndices.size();
    CARB_ASSERT(numIndices % 4 == 0);
...
void TetrahedralMeshVisualizerDeprecated::computeRenderMeshColorsWithoutGap(VtArray<GfVec3f>& newColors)
{
    const size_t numSurfaceTriangles = mSurfaceTriangles.size() / 3;
...
void TetrahedralMeshVisualizerDeprecated::computeRenderMeshColorsWithGap(VtArray<GfVec3f>& newColors)
{
...
void TetrahedralMeshVisualizerDeprecated::calculateMeshTopology()
{
...
void TetrahedralMeshVisualizerDeprecated::updateTetPointsInternal()
{
    VtVec3fArray newPoints;
#if 0
    // TODO: Revisit gap == 0.0 case to solve the rendering issue
