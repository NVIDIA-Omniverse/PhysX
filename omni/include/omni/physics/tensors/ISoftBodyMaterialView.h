...
public:
    ...
    virtual bool getDampingScale(const TensorDesc* dstTensor) const = 0;
    virtual bool setDampingScale(const TensorDesc* srcTensor, const TensorDesc* indexTensor) = 0;
    virtual bool setDampingScaleMasked(const TensorDesc* srcTensor, const TensorDesc* maskTensor) = 0;

    virtual bool check() const = 0;
    virtual void release() = 0;

protected:
    virtual ~ISoftBodyMaterialView() = default;
};
