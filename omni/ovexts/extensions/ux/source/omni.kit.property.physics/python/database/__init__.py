...
extra_add_items = [
    ...
    ExtraAddItem(
        ...
        lambda p: p.IsA(UsdGeom.TetMesh) and not pxb.hasconflictingapis_DeformableBodyAPI(p, True),
    ),
    ExtraAddItem(
        ...
        lambda p: p.IsA(UsdGeom.Mesh) and not pxb.hasconflictingapis_DeformableBodyAPI(p, True),
    ),
    ExtraAddItem(
