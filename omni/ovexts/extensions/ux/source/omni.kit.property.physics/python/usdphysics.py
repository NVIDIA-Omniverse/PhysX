...
property_builders = {
    ...
    "physics:approximation": [PrettyPrintTokenComboBuilder, ["Triangle Mesh", "Convex Decomposition", "Convex Hull", "Bounding Sphere", "Bounding Cube", "Mesh Simplification", "SDF Mesh", "Sphere Approximation"]],
