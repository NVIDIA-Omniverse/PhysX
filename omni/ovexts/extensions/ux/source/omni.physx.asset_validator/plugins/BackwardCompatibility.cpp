...
bool removeAttributeFromReference(PXR_NS::UsdStageWeakPtr stage, const TfToken& atrrToken, UsdPrim& usdPrim)
{
...
void setTypeName(PXR_NS::UsdStageWeakPtr stage, const TfToken& newTypeName, UsdPrim& usdPrim)
{
...
template<typename T>
bool switchDoubleToFloat(PXR_NS::UsdStageWeakPtr stage, const TfToken& attrToken, UsdPrim& usdPrim, T& val)
{
...
template<typename T>
bool switchRadToDegree(PXR_NS::UsdStageWeakPtr stage, const TfToken& attrToken, UsdPrim& usdPrim)
{
    UsdAttribute attribute = usdPrim.GetAttribute(attrToken);
    if (attribute)
    {
...
template<typename T>
bool switchDegreeToRad(PXR_NS::UsdStageWeakPtr stage, const TfToken& attrToken, UsdPrim& usdPrim)
{
    UsdAttribute attribute = usdPrim.GetAttribute(attrToken);
    if (attribute)
    {
...
void modifyFloatAttribute(PXR_NS::UsdStageWeakPtr stage, const TfToken& attrToken, UsdPrim& usdPrim, float modifyVal)
{
    UsdAttribute attribute = usdPrim.GetAttribute(attrToken);
    if (attribute)
    {
...
bool renameProperty(PXR_NS::UsdStageWeakPtr stage, UsdPrim& prim, const char* oldName, const char* newName)
{    
...
void removeProperty(PXR_NS::UsdStageWeakPtr stage, UsdPrim& prim, const char* propName)
{
...
VtValue checkPhysxAttribute(PXR_NS::UsdStageWeakPtr stage, const TfToken& oldToken, UsdPrim& usdPrim)
{
    VtValue val;
...
VtValue getAttribute(PXR_NS::UsdStageWeakPtr stage, TfToken& oldToken, UsdPrim& usdPrim)
{
    VtValue val;
    UsdAttribute attr = usdPrim.GetAttribute(oldToken);
    if (attr)
...
auto checkAttributes = [](const PXR_NS::UsdPrim& usdPrim, const TfTokenVector& tokens, const std::string& primPathStr,
...
void checkJoints(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkSchemas(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{   
...
void checkPhysicsMaterialAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkScenes(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxCookedDataAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
    // A.B. temp disable
    //for (auto& usdrtPath : usdrtStage->GetPrimsWithAppliedAPIName(usdrt::TfToken("PhysxCookedDataAPI")))
    //{
    //    const PXR_NS::SdfPath usdPath = omni::fabric::toSdfPath(omni::fabric::PathC(usdrtPath));
    //    UsdPrim usdPrim = stage->GetPrimAtPath(usdPath);
    //    const std::string& primPathStr = usdrtPath.GetString();
...
void checkPhysxSchemaPhysxSceneAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxRigidBodyAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxTriangleMeshCollisionAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaUsdPhysicsCollisionAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxCollisionAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxMaterialAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxJointAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxArticulationAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxArticulationForceSensorAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxArticulationJoint(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
    for (auto& usdrtPath : usdrtStage->GetPrimsWithTypeName(usdrt::TfToken("UsdPhysicsJoint")))
    {
        const omni::fabric::Path fabricPath(usdrtPath);
...
void checkUsdPhysicsRevoluteJoint(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkUsdPhysicsSphericalJoint(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxTriggerAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxVehicle(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{    
    // vehicle old types
...
void checkPhysxSchemaPhysxVehicleContextAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
void checkPhysxSchemaPhysxVehicleControllerAPI(bool& ret, PXR_NS::UsdStageWeakPtr stage, usdrt::UsdStageRefPtr usdrtStage)
{
...
bool checkPrimPassive(PXR_NS::UsdStageWeakPtr stage, const PXR_NS::UsdPrim& usdPrim)
{
    bool ret = false;
    ...
    auto checkTypes = [](const PXR_NS::UsdPrim& usdPrim, const TfTokenVector& tokens, const std::string& primPathStr) -> bool {
        bool ret = false;
        for (const TfToken& token : tokens)
        {
...
{
    PXR_NS::UsdPrim scenePrim;
    PXR_NS::UsdPrim oldVehicleGlobalSettingsPrim;
};

void checkPrim(PXR_NS::UsdStageWeakPtr stage, PXR_NS::UsdPrim& usdPrim, SecondPassPrimTracker& secondPassPrimTracker)
{
    const SdfPath primPath = usdPrim.GetPrimPath();
    ...
    for (size_t i = 0; i < appliedSchemas.size(); i++)
    {
        ...
        {            
            ...
            switchRadToDegree<PXR_NS::GfVec3f>(stage, TfToken("angularVelocity"), usdPrim);
...
void processSecondPassPrims(PXR_NS::UsdStageWeakPtr stage, SecondPassPrimTracker& secondPassPrimTracker)
{
    CARB_PROFILE_ZONE(0, "USD Load processSecondPassPrims");

    if (secondPassPrimTracker.oldVehicleGlobalSettingsPrim.IsValid())
    {
        PXR_NS::UsdPrim& settingsPrim = secondPassPrimTracker.oldVehicleGlobalSettingsPrim;
        ...
        PXR_NS::UsdPrim& scenePrim = secondPassPrimTracker.scenePrim;
...
static PXR_NS::TfToken customLayerDataToken("customLayerData");
static PXR_NS::TfToken coneToken("physicsSettings:/physics/collisionConeCustomGeometrySetting");
static PXR_NS::TfToken cylinderToken("physicsSettings:/physics/collisionCylinderCustomGeometry");

void checkMetadata(bool& ret, PXR_NS::UsdStageWeakPtr stage)
{
...
void fixMetadata(PXR_NS::UsdStageWeakPtr stage)
{
...
void runBackwardCompatibilityOnStage(PXR_NS::UsdStageWeakPtr stage)
{
    ...
    PXR_NS::UsdPrimRange range = stage->TraverseAll();
    SecondPassPrimTracker secondPassPrimTracker;
    for (PXR_NS::UsdPrim prim : range)
    {
        if (!prim)
            continue;
...
bool checkBackwardCompatibilityOnStage(PXR_NS::UsdStageWeakPtr stage)
{
    gCheckLog.clear();
    bool ret = false;
    ...
    {
        CARB_LOG_ERROR("PhysXAssetValidator: Failed to acquire omni::fabric::IStageReaderWriter");
        return false;
    }
