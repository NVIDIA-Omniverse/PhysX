...
CameraController::CameraController(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
{
    mCameraPrim = prim;
...
void CameraController::updateAxes()
{
    ...
    TfToken usdUpAxis = PXR_NS::UsdGeomGetStageUpAxis(stage);
...
void CameraController::readUsdSettings(const PXR_NS::UsdTimeCode& timeCode)
{
