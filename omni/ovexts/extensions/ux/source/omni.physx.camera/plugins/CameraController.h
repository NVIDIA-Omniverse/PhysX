...
{
protected:
    CameraController(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim);
...
public:
    ...
    inline const PXR_NS::UsdPrim& getPrim()
    {
        return mCameraPrim;
    }

    inline const PXR_NS::SdfPath& getSubjectPath()
    {
        return mSubjectPath;
    }
...
protected:
    ...
    virtual void readUsdSettings(const PXR_NS::UsdTimeCode& timeCode);

protected:
    PXR_NS::SdfPath mCameraPath;
    PXR_NS::UsdPrim mCameraPrim;
    PXR_NS::SdfPath mSubjectPath;
    PXR_NS::UsdPrim mSubjectPrim;
    ...
    PXR_NS::GfMatrix4d mInitialCameraMatrix;
    PXR_NS::GfMatrix4d mCameraMatrix;
