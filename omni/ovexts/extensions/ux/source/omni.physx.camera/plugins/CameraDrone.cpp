...
CameraDrone::CameraDrone(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim) : CameraController(prim, subjectPrim)
{
    // Subject states
...
CameraDrone* CameraDrone::create(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
{
...
void CameraDrone::readUsdSettings(const PXR_NS::UsdTimeCode& timeCode)
{
...
{
    // Update subject transform and velocity.
