...
{
private:
    CameraDrone(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim);
    virtual ~CameraDrone();

public:
    static CameraDrone* create(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim);
