...
CameraFollow::CameraFollow(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
...
void CameraFollow::readUsdSettings(const PXR_NS::UsdTimeCode& timeCode)
{
