...
CameraFollowLook::CameraFollowLook(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
...
CameraFollowLook* CameraFollowLook::create(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
{
...
void CameraFollowLook::readUsdSettings(const PXR_NS::UsdTimeCode& timeCode)
{
