...
CameraFollowVelocity::CameraFollowVelocity(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
...
CameraFollowVelocity* CameraFollowVelocity::create(const PXR_NS::UsdPrim& prim, const PXR_NS::UsdPrim& subjectPrim)
{
