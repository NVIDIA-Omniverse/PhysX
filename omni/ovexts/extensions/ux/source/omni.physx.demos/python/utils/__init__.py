...
def set_contact_offset(prim, contact_offset=2.0, rest_offset=0.0):
    """Set contact and rest offsets on a collision prim to prevent tunneling at cm scale."""
    physxCollisionAPI = PhysxSchema.PhysxCollisionAPI.Apply(prim)
    physxCollisionAPI.CreateContactOffsetAttr(contact_offset)
    physxCollisionAPI.CreateRestOffsetAttr(rest_offset)
