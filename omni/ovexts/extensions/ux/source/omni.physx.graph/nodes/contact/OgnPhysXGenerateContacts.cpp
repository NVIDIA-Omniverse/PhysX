...
public:
    static bool compute(OgnPhysXGenerateContactsDatabase& db)
    {
        ...
        for (::physx::PxU32 i = 0; i < pairCount; ++i)
        {
            ...
            const ::physx::PxShape* shape0 = reinterpret_cast<const ::physx::PxShape*>(physXInterface->getPhysXPtr(PXR_NS::SdfPath(shape0Path), omni::physx::ePTShape));
            if (shape0 == nullptr)
            {
            ...
            const ::physx::PxShape* shape1 = reinterpret_cast<const ::physx::PxShape*>(physXInterface->getPhysXPtr(PXR_NS::SdfPath(shape1Path), omni::physx::ePTShape));
            if (shape1 == nullptr)
            {
        ...
        ::physx::PxPhysics* pxPhysics = reinterpret_cast<::physx::PxPhysics*>(physXInterface->getPhysXPtr(PXR_NS::SdfPath(), omni::physx::ePTPhysics));
