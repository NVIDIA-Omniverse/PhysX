...
public:
    ...
    static bool compute(OgnPhysXImmediateComputeGeometryBoundsDatabase& db)
    {
        ...
        static const NameToken point3Token = omni::fabric::Token::createImmortal(PXR_NS::TfToken("pointf[3]").GetText());
        static const NameToken uint128Token = omni::fabric::Token::createImmortal(PXR_NS::TfToken("uint64[]").GetText());
