...
public:
    ...
    static bool compute(OgnVehicleGetWheelStateDatabase& db)
    {
        ...
        omni::graph::core::ogn::array<PXR_NS::GfVec4f>& groundPlanes = db.outputs.groundPlanes();
        omni::graph::core::ogn::array<PXR_NS::GfVec3f>& groundPositions = db.outputs.groundHitPositions();
        ...
        omni::graph::core::ogn::array<PXR_NS::GfVec3f>& suspensionForces = db.outputs.suspensionForces();
        ...
        omni::graph::core::ogn::array<PXR_NS::GfVec3f>& tireLongitudinalDirections = db.outputs.tireLongitudinalDirections();
        omni::graph::core::ogn::array<PXR_NS::GfVec3f>& tireLateralDirections = db.outputs.tireLateralDirections();
        omni::graph::core::ogn::array<PXR_NS::GfVec3f>& tireForces = db.outputs.tireForces();
        ...
        omni::physx::usdparser::ObjectId* wheelObjectIds = NULL;
        {
            ...
            for (uint32_t i = 0; i < uint32_t(nb); i++)
            {
                ...
                const omni::physx::usdparser::ObjectId wheelObjectId = physXInterface->getObjectId(PXR_NS::SdfPath(wheelAttachmentPath), omni::physx::PhysXType::ePTVehicleWheelAttachment);
