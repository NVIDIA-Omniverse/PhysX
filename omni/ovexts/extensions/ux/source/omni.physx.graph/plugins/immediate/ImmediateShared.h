...
{
    PXR_NS::GfMatrix4d gfWorldMatrix(1.0);
    ...
    PXR_NS::GfBBox3d bbox = PXR_NS::GfBBox3d(
        PXR_NS::GfRange3d(omni::physx::toVec3d(bounds.minimum), omni::physx::toVec3d(bounds.maximum)), gfWorldMatrix);
