...
{
    std::vector<PXR_NS::SdfPath> actorPaths;     // All actor prim paths
    std::vector<PXR_NS::SdfPath> jointPaths;     // All joint prim paths
    std::vector<PXR_NS::SdfPath> jointRcPaths;   // All articulation joint prim paths
    PXR_NS::TfHashMap<uint64_t, PXR_NS::SdfPath> actorMap; // Handle -> Path mapping
