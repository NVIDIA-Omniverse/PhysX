...
class PhysXInspectorModelImpl : public PhysXInspectorModel
{
    ...
    bool isIncludedInCurrentSelection(const PXR_NS::SdfPath& path) const;
    ...
    void findCollisionAPIFor(const PXR_NS::SdfPath& path, PXR_NS::SdfPathVector& collisionApis);

    PXR_NS::SdfPath getPathForUserData(void* userData) const;
    ...
    static bool tryReadJointDrive(PXR_NS::UsdPrim& prim, float& value);
    static bool tryReadJointVelocity(PXR_NS::UsdPrim& prim, float& value);
    static bool tryReadJointState(PXR_NS::UsdPrim& prim, float& value);
    static bool tryWriteJointVelocity(PXR_NS::UsdPrim& prim, float value);
    static bool tryWriteJointDrive(PXR_NS::UsdPrim& prim, float value);
    static bool tryWriteJointState(PXR_NS::UsdPrim& prim, float value);

    bool isArticulationJoint(const PXR_NS::SdfPath& path) const;
    ::physx::PxArticulationLink* findRootLink(::physx::PxArticulationReducedCoordinate* articulation);

public:
    PhysXInspectorModelImpl(const PXR_NS::SdfPathVector& selection, PhysXInspector* inspector);
