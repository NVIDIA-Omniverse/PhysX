...
inline ImVec2 projectWorldToScreen(const PXR_NS::GfVec4d& worldPos,
                                         const PXR_NS::GfMatrix4d& mat,
                                         const carb::Float4& viewPortRect,
                                         PXR_NS::GfVec4d& viewProjectionSpace)
{
    viewProjectionSpace = worldPos * mat;
    PXR_NS::GfVec4d clipSpace = viewProjectionSpace;
    clipSpace *= 0.5f / clipSpace[3];
    clipSpace += PXR_NS::GfVec4d(double(0.5), double(0.5), double(0.0), double(0.0));
...
void PhysXInspectorOverlayImpl::drawViewportOverlays(const PXR_NS::GfMatrix4d modelViewProjection, carb::Float4 viewportRect)
{
    using namespace physx;
...
void PhysXInspectorOverlayImpl::drawViewportOverlayMasses()
{
    ...
    for (::physx::PxU32 idx = 0; idx < numLinks; ++idx)
    {
        ...
        PXR_NS::GfVec4d viewProjectionPoint;
        ImVec2 projectedCenterOfMass = projectWorldToScreen(
            PXR_NS::GfVec4d{ globalCenterOfMass.p.x, globalCenterOfMass.p.y, globalCenterOfMass.p.z, 1.0 },
