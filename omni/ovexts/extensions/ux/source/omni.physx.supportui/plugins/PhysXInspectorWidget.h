...
private:
    ...
    void drawSelectionJointsContextMenu(const PXR_NS::SdfPath& jointPath);
    void drawSelectionBodiesContextMenu(const PXR_NS::SdfPath& bodyPath);
    ...
    void drawJointSlider(const PXR_NS::SdfPath& jointPath);
