...
void RigidBodyManipulatorHelper::onManipulationBegan(const PXR_NS::SdfPath& path)
{
...
void RigidBodyManipulatorHelper::onManipulationEnded(const PXR_NS::SdfPath& path)
{
...
void RigidBodyManipulatorHelper::update(float dt)
{
    ...
    {
        const PXR_NS::SdfPath& path = iter->first;
        if(path.IsEmpty())
        {
            OMNI_LOG_WARN(kSupportUiLogChannel,
...
bool RigidBodyManipulatorHelper::move(const PXR_NS::SdfPath& path,
...
bool RigidBodyManipulatorHelper::rotate(const PXR_NS::SdfPath& path,
...
::physx::PxActor* RigidBodyManipulatorHelper::getPxActor(const PXR_NS::SdfPath& path) const
{
...
RigidBodyManipulatorHelper::ActorManipulator::ActorManipulator(RigidBodyManipulatorHelper* helper, const PXR_NS::SdfPath& path) :
                        helper(helper),
                        path(path),
