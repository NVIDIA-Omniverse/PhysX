...
class ParticleVisualizationTestKitStage(PhysicsKitStageAsyncTestCase):
    ...
    def _check_particle_positions(self, fluidEqual=True, solidEqual=True):
        if fluidEqual:
    ...
    def _check_particle_offsets_and_visibility(self, offset_id):
        ...
        self._check_particle_positions(fluidEqual=True, solidEqual=True)
    ...
    def _check_particles_smoothing(self, position_type: pb.ParticleVisualizationPositionType):
        ...
        self._check_particle_positions(fluidEqual=fluid_must_be_equal, solidEqual=True)
