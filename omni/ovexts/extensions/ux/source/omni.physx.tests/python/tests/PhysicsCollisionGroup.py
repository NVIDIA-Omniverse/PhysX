...
class PhysicsCollisionGroupTestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, FilterTestBase):
    ...
    async def test_collision_group_particles_with_others(self):
        ...
        await self.run_collision_group_tests(dyn_type = 'Particles', stc_type = 'VolumeDeformableNonHierarchy')
        await self.run_collision_group_tests(dyn_type = 'Particles', stc_type = 'VolumeDeformableHierarchyXform')
        await self.run_collision_group_tests(dyn_type = 'Particles', stc_type = 'SurfaceDeformableNonHierarchy')
        await self.run_collision_group_tests(dyn_type = 'Particles', stc_type = 'SurfaceDeformableHierarchyXform')
