...
class PhysicsFilteredPairsAPITestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase, FilterTestBase):
    ...
    async def test_filtered_pairs_particles_with_others(self):
        ...
        await self.run_filtered_pairs_tests(dyn_type = 'Particles', stc_type = 'VolumeDeformableNonHierarchy')
        await self.run_filtered_pairs_tests(dyn_type = 'Particles', stc_type = 'VolumeDeformableHierarchyXform')
        await self.run_filtered_pairs_tests(dyn_type = 'Particles', stc_type = 'SurfaceDeformableNonHierarchy')
        await self.run_filtered_pairs_tests(dyn_type = 'Particles', stc_type = 'SurfaceDeformableHierarchyXform')
