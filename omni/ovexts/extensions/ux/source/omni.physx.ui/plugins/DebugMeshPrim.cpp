...
static void getColor(PXR_NS::GfVec3f &rgb,uint32_t color)
{
    ...
    public:
        ...
        virtual bool createDebugMeshPrim(const char *primName, const DebugMesh &mesh,uint32_t meshColor) final
        {
            ...
            if ( gStage )
            {
                PXR_NS::SdfPath primPath(primName);
                gStage->RemovePrim(primPath); // remove any previous version of this prim
                PXR_NS::UsdGeomMesh meshPrim = PXR_NS::UsdGeomMesh::Define(gStage,primPath);
                PXR_NS::UsdPrim prim = gStage->GetPrimAtPath(primPath);
                if ( prim )
                {
                    setMetaData(prim,getCollisionMeshToken(),"collision");
                    PXR_NS::GfVec3f color;
                    getColor(color,meshColor);
                    PXR_NS::VtArray<PXR_NS::GfVec3f> colorArray(1,color);
                    meshPrim.CreateDisplayColorAttr().Set(colorArray);

                    PXR_NS::VtArray<int> meshFaceVertexCounts;
                    ...
                    PXR_NS::VtArray<PXR_NS::GfVec3f> meshPoints;
                    ...
                    PXR_NS::VtArray<PXR_NS::GfVec3f> meshNormals;
                    ...
                    meshPrim.SetNormalsInterpolation(PXR_NS::UsdGeomTokens->uniform);
                    ...
                    meshPrim.CreateSubdivisionSchemeAttr(PXR_NS::VtValue(PXR_NS::UsdGeomTokens->none));
