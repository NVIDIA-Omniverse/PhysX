...
{
    mViewMatrix = PXR_NS::GfMatrix4d(1.0);
...
static carb::Double3 convertToDouble3(const PXR_NS::GfVec3d& v) { return carb::Double3{ v[0], v[1], v[2] }; }
...
void DebugVisualizationPhysX::updateVisualizationCullBox()
{
    ...
    else
    {
        ...
        PXR_NS::GfVec3d a1 = cameraMatrix.GetRow3(0);
        PXR_NS::GfVec3d a2 = cameraMatrix.GetRow3(1);
        PXR_NS::GfVec3d a3 = -cameraMatrix.GetRow3(2);
        PXR_NS::GfVec3d trans = cameraMatrix.ExtractTranslation();
