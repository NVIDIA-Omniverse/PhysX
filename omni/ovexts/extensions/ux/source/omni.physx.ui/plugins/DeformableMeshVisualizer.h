...
public:
    ...
    virtual void setPoints(const PXR_NS::VtArray<PXR_NS::GfVec3f>& originalPoints) = 0;
    virtual void setIndices(const PXR_NS::VtArray<int>& indices) = 0;
    virtual void setGapValue(const float gap) = 0;
    virtual void setColors(const PXR_NS::VtArray<PXR_NS::GfVec3f>& colors) = 0;
