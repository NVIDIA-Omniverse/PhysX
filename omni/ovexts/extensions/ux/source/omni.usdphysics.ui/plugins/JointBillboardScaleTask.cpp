...
void JointBillboardScaleTask::initialize(const PXR_NS::GfVec3f& camPos, const JointDataMap& jointDataMap,
    const PXR_NS::GfMatrix4d& viewProjection, const PXR_NS::GfMatrix4d& viewInverse, const carb::Float4& viewPortRect,
    carb::settings::ISettings* settings, PXR_NS::UsdStageWeakPtr stage)
{
    if (!mTasking)
        return;
