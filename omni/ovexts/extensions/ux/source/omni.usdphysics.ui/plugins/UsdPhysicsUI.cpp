...
struct ExtensionImpl : public omni::ext::IExt, public PXR_NS::TfWeakBase
{
    ...
    void onStartup(const char* extId) override
    {
        ...
        mUsdNoticeListenerKey =
            PXR_NS::TfNotice::Register(PXR_NS::TfCreateWeakPtr(&mUsdNoticeListener), &UsdPhysicsUINoticeListener::handle);
