...
void UsdPhysicsUINoticeListener::handle(const PXR_NS::UsdNotice::ObjectsChanged& objectsChanged)
{
...
void JointAuthoringManager::handleUsdNotice(const PXR_NS::UsdNotice::ObjectsChanged& objectsChanged)
{
