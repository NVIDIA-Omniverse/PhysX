...
struct IUsdPhysicsParse
{
    ...
    schema::JointDesc*(CARB_ABI* parseJoint)(uint64_t stageId, const PXR_NS::SdfPath& path);
    ...
    /// IUsdPhysicsParse::releaseDesc
    schema::AttachmentDesc*(CARB_ABI* parseAttachment)(uint64_t stageId, const PXR_NS::SdfPath& path);
    ...
    schema::ElementCollisionFilterDesc*(CARB_ABI* parseCollisionFilter)(uint64_t stageId, const PXR_NS::SdfPath& path);
};
