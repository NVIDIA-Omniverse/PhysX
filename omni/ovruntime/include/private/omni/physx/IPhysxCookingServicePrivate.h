...
constexpr static int PhysxCookingDataVersion_DeformableVolumeMesh = 5; // The current version number of cooked data for deformable volume meshes
constexpr static int PhysxCookingDataVersion_VolumeDeformableBody = 3; // The current version number of cooked data for volume deformable body meshes
...
{
    CARB_PLUGIN_INTERFACE("omni::physx::IPhysxCookingServicePrivate", 15, 0)
