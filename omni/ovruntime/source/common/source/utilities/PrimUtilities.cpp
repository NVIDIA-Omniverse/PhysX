...
namespace primutils
{
    ...
    {
        auto getJointBodyTransform = [&xfCache](const PXR_NS::UsdPrim& bodyPrim, const PXR_NS::GfVec3f& gfLocPos,
            ...
            if (bodyPrim.IsValid())
            {
                ...
                const PXR_NS::GfVec3f scale = PXR_NS::GfVec3f(PXR_NS::GfTransform(mat).GetScale());
        ...
        const PXR_NS::UsdPrim body0prim = stage->GetPrimAtPath(body0);
        const PXR_NS::UsdPrim body1prim = stage->GetPrimAtPath(body1);

        const PXR_NS::GfTransform body0tm = getJointBodyTransform(body0prim, localPose0Position, localPose0Orientation);
        const PXR_NS::GfTransform body1tm = getJointBodyTransform(body1prim, localPose1Position, localPose1Orientation);
