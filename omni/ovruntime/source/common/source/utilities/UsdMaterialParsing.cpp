...
{
    PXR_NS::TfType schemaType = PXR_NS::UsdSchemaRegistry::GetAPITypeFromSchemaTypeName(OmniPhysicsDeformableAPITokens->BaseMaterialAPI);
...
void parseDeformableMaterial(const UsdStageWeakPtr stage, const UsdPrim& usdPrim, omni::physics::schema::DeformableMaterialDesc& desc)
{
    ...
    PXR_NS::TfType schemaType = PXR_NS::UsdSchemaRegistry::GetAPITypeFromSchemaTypeName(OmniPhysicsDeformableAPITokens->DeformableMaterialAPI);
    if (usdPrim.HasAPI(schemaType))
    {
                                    ...
                                    omni::physics::schema::SurfaceDeformableMaterialDesc& desc)
{
    ...
    PXR_NS::TfType schemaType = UsdSchemaRegistry::GetAPITypeFromSchemaTypeName(OmniPhysicsDeformableAPITokens->SurfaceDeformableMaterialAPI);
    if (usdPrim.HasAPI(schemaType))
    {
                                   ...
                                   omni::physics::schema::CurvesDeformableMaterialDesc& desc)
{
    ...
    PXR_NS::TfType schemaType = PXR_NS::UsdSchemaRegistry::GetAPITypeFromSchemaTypeName(OmniPhysicsDeformableAPITokens->CurvesDeformableMaterialAPI);
    if (usdPrim.HasAPI(schemaType))
    {
