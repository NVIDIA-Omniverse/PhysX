...
public:
    ...
    {
        PYBIND11_OVERLOAD_NAME(int, ISimulationView, "get_param_device_ordinal", getParamDeviceOrdinal);
    }
...
PYBIND11_MODULE(_physicsTensors, m)
{
    ...
    py::class_<ISimulationView, PySimulationView, std::unique_ptr<ISimulationView, PySimulationView::Deleter>>(
        ...
        .def_property_readonly("param_device_ordinal", &ISimulationView::getParamDeviceOrdinal)
    ...
    defineInterfaceClass<TensorApi>(m, "TensorApi", "acquire_tensor_api", "release_tensor_api")
        .def("create_simulation_view", wrapInterfaceFunction(&TensorApi::createSimulationView),
             py::arg("stage_id") = -1L, py::arg("backend_name") = nullptr, py::return_value_policy::take_ownership)
        .def("reset", wrapInterfaceFunction(&TensorApi::reset), py::arg("backend_name") = nullptr);
