...
struct UjitsoCookingComputeService : public ICookingComputeService
{
    ...
    {
        CARB_PROFILE_ZONE(0, "UjitsoCookingComputeService::requestDeformableVolumeMeshCookedData");
        ...
        // Call generic cooking function to handle deformable volume mesh
        return requestCookedData(PhysxCookingDataType::eDEFORMABLE_VOLUME_MESH, context, request,
            [&](const PhysxCookingComputeResult& result) {
            ...
            MeshCookingContext* cooking =
                MeshCookingContext::create(m_resourceManager, cacheBehavior(request), result,
                    PhysxCookingDataVersion_DeformableVolumeMesh, PhysxAdditionAPITokens->BaseDeformableBodyAPI);
    ...
    {
        CARB_PROFILE_ZONE(0, "UjitsoCookingComputeService::requestVolumeDeformableBodyCookedData");
        ...
        // Call generic cooking function to handle volume deformable body
        return requestCookedData(PhysxCookingDataType::eVOLUME_DEFORMABLE_BODY, context, request,
            [&](const PhysxCookingComputeResult& result) {
            ...
            MeshCookingContext* cooking =
                MeshCookingContext::create(m_resourceManager, cacheBehavior(request), result,
                    PhysxCookingDataVersion_VolumeDeformableBody, PhysxAdditionAPITokens->BaseDeformableBodyAPI);
            addParamsToRequest(cooking->getRequestBuilder(), params);
            return cooking;
        });
    }
    ...
    {
        CARB_PROFILE_ZONE(0, "UjitsoCookingComputeService::requestSurfaceDeformableBodyCookedData");
        ...
        // Call generic cooking function to handle surface deformable body
        return requestCookedData(PhysxCookingDataType::eSURFACE_DEFORMABLE_BODY, context, request,
            [&](const PhysxCookingComputeResult& result) {
            ...
            MeshCookingContext* cooking =
                MeshCookingContext::create(m_resourceManager, cacheBehavior(request), result,
                    PhysxCookingDataVersion_SurfaceDeformableBody, PhysxAdditionAPITokens->BaseDeformableBodyAPI);
            addParamsToRequest(cooking->getRequestBuilder(), params);
            return cooking;
        });
    }
...
private:
    ...
    void setDevKey(uint64_t devKey)
    {
        ...
        case kDefaultDeveloperKey:
            ...
            break;
        case static_cast<uint64_t>(kUniqueDeveloperKey):
