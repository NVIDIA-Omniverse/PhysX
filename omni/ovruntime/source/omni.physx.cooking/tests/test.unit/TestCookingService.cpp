...
struct CookingServiceTestParameters
{
    ...
    void createShared()
    {
        CookingTest& cookingTests = *CookingTest::getCookingTests();

        physxCooking = cookingTests.acquireCookingServiceInterface();
        physxCookingPrivate = cookingTests.acquireCookingServicePrivateInterface();
...
void testCookingServiceCooking()
{
    ...
    CookingTest& cookingTests = *CookingTest::getCookingTests();
    omni::physx::IPhysxCookingService* physxCooking = cookingTests.acquireCookingServiceInterface();
    REQUIRE(physxCooking);
...
static void testMultiThreadedParametric(const bool asynchronous, const bool caching)
{
    ...
    CookingTest& cookingTests = *CookingTest::getCookingTests();
    auto physxCooking = cookingTests.acquireCookingServiceInterface();
    auto physxCookingPrivate = cookingTests.acquireCookingServicePrivateInterface();
...
void testCookingServiceContextAndCancellations()
{
    ...
    omni::physx::IPhysxCookingServicePrivate* physxCookingPrivate =
        cookingTests.acquireCookingServicePrivateInterface();
    REQUIRE(physxCooking);
    REQUIRE(physxCookingPrivate);
    // Always start with empty cache
    resetLocalMeshCaches(physxCookingPrivate);
