...
OMNI_APP_GLOBALS("cooking.test.unit", "Omniverse physics cooking unit tests.")
...
int main(int argc, char** argv)
{
    ...
    CookingTest* cookingTestGlobal = CookingTest::getCookingTests();
