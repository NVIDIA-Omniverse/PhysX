...
namespace detail
{
PYBOOST11_TYPE_CASTER(PXR_NS::UsdPrim, _("UsdPrim"));
PYBOOST11_TYPE_CASTER(PXR_NS::TfType, _("TfType"));
} // namespace detail
} // namespace pybind11
...
PYBIND11_MODULE(_physx, m)
{
    ...
    m.attr("PERF_ENV_API") = py::str(PXR_NS::PhysxAdditionAPITokens->DrivePerformanceEnvelopeAPI);
    m.attr("JOINT_AXIS_API") = py::str(PXR_NS::PhysxAdditionAPITokens->PhysxJointAxisAPI);

    m.attr("PERF_ENV_ATTR_MAX_ACTUATOR_VELOCITY_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxActuatorVelocityAngular);
    m.attr("PERF_ENV_ATTR_MAX_ACTUATOR_VELOCITY_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxActuatorVelocityLinear);
    m.attr("PERF_ENV_ATTR_MAX_ACTUATOR_VELOCITY_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxActuatorVelocityRotX);
    m.attr("PERF_ENV_ATTR_MAX_ACTUATOR_VELOCITY_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxActuatorVelocityRotY);
    m.attr("PERF_ENV_ATTR_MAX_ACTUATOR_VELOCITY_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxActuatorVelocityRotZ);

    m.attr("PERF_ENV_ATTR_VELOCITY_DEPENDENT_RESISTANCE_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->velocityDependentResistanceAngular);
    m.attr("PERF_ENV_ATTR_VELOCITY_DEPENDENT_RESISTANCE_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->velocityDependentResistanceLinear);
    m.attr("PERF_ENV_ATTR_VELOCITY_DEPENDENT_RESISTANCE_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->velocityDependentResistanceRotX);
    m.attr("PERF_ENV_ATTR_VELOCITY_DEPENDENT_RESISTANCE_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->velocityDependentResistanceRotY);
    m.attr("PERF_ENV_ATTR_VELOCITY_DEPENDENT_RESISTANCE_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->velocityDependentResistanceRotZ);

    m.attr("PERF_ENV_ATTR_SPEED_EFFORT_GRADIENT_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->speedEffortGradientAngular);
    m.attr("PERF_ENV_ATTR_SPEED_EFFORT_GRADIENT_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->speedEffortGradientLinear);
    m.attr("PERF_ENV_ATTR_SPEED_EFFORT_GRADIENT_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->speedEffortGradientRotX);
    m.attr("PERF_ENV_ATTR_SPEED_EFFORT_GRADIENT_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->speedEffortGradientRotY);
    m.attr("PERF_ENV_ATTR_SPEED_EFFORT_GRADIENT_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->speedEffortGradientRotZ);

    m.attr("JOINT_AXIS_ATTR_ARMATURE_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->armatureAngular);
    m.attr("JOINT_AXIS_ATTR_ARMATURE_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->armatureLinear);
    m.attr("JOINT_AXIS_ATTR_ARMATURE_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->armatureRotX);
    m.attr("JOINT_AXIS_ATTR_ARMATURE_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->armatureRotY);
    m.attr("JOINT_AXIS_ATTR_ARMATURE_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->armatureRotZ);
    
    m.attr("JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxJointVelocityAngular);
    m.attr("JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxJointVelocityLinear);
    m.attr("JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxJointVelocityRotX);
    m.attr("JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxJointVelocityRotY);
    m.attr("JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->maxJointVelocityRotZ);
    
    m.attr("JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->staticFrictionEffortAngular);
    m.attr("JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->staticFrictionEffortLinear);
    m.attr("JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->staticFrictionEffortRotX);
    m.attr("JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->staticFrictionEffortRotY);
    m.attr("JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->staticFrictionEffortRotZ);
    
    m.attr("JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->dynamicFrictionEffortAngular);
    m.attr("JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->dynamicFrictionEffortLinear);
    m.attr("JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->dynamicFrictionEffortRotX);
    m.attr("JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->dynamicFrictionEffortRotY);
    m.attr("JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->dynamicFrictionEffortRotZ);
    
    m.attr("JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ANGULAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->viscousFrictionCoefficientAngular);
    m.attr("JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_LINEAR") = py::str(PXR_NS::PhysxAdditionAttrTokens->viscousFrictionCoefficientLinear);
    m.attr("JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTX") = py::str(PXR_NS::PhysxAdditionAttrTokens->viscousFrictionCoefficientRotX);
    m.attr("JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTY") = py::str(PXR_NS::PhysxAdditionAttrTokens->viscousFrictionCoefficientRotY);
    m.attr("JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTZ") = py::str(PXR_NS::PhysxAdditionAttrTokens->viscousFrictionCoefficientRotZ);
    ...
    m.def("hasconflictingapis_RigidBodyAPI_WRet",
        [](const PXR_NS::UsdPrim& prim, bool check_itself, bool check_prim) {
            PXR_NS::UsdPrim ret;
    ...
    dev.def("get_rigidbody_transformation", [](IPhysx* iface, const char* path) {
        ...
        const PXR_NS::SdfPath rbPath = PXR_NS::SdfPath(path);
        carb::Float3 pos;
        carb::Float4 rot;
    ...
    {
            return self->setVoxelRange(stageId, PXR_NS::SdfPath(path), sx, sy, sz, ex, ey, ez, type, subType, update);
    },
    ...
    dev.def(
        ...
        {
            usdparser::ObjectId id = physX->getObjectId(PXR_NS::SdfPath(path), PhysXType::ePTVehicle);
    ...
    dev.def(
        ...
        [](const IPhysx* physX, const char* path)
        {
            usdparser::ObjectId id = physX->getObjectId(PXR_NS::SdfPath(path), PhysXType::ePTVehicleController);
    ...
    dev.def(
        ...
        [](const IPhysx* physX, const char* path)
        {
            usdparser::ObjectId id = physX->getObjectId(PXR_NS::SdfPath(path), PhysXType::ePTVehicleWheelAttachment);
            if (id != usdparser::kInvalidObjectId)
            {
    ...
    py::class_<SceneQueryHitObject>(m, "SceneQueryHitObject", R"(
        ...
        .def_property_readonly("collision",
            [](const SceneQueryHitObject* self)
            {
                const PXR_NS::SdfPath path = intToPath(self->collision);
                return path.GetText();
            },
       ...
       .def_property_readonly("rigid_body",
            [](const SceneQueryHitObject* self)
            {
                const PXR_NS::SdfPath path = intToPath(self->rigidBody);
                return path.GetText();
            },
    ...
    py::class_<SceneQueryHitLocation, SceneQueryHitObject>(m, "SceneQueryHitLocation", R"(
        ...
        .def_property_readonly(
            "material",
            [](const SceneQueryHitLocation* self) {
                const PXR_NS::SdfPath path = intToPath(self->material);
                return path.GetText();
            },
    ...
    dev.def("raycast_closest",
        ...
        if (retVal)
        {
            ...
            const PXR_NS::SdfPath collisionPath = intToPath(hit.collision);
            hitInfo["collision"] = collisionPath.GetText();
            const PXR_NS::SdfPath rbPath = intToPath(hit.rigidBody);
            hitInfo["rigidBody"] = rbPath.GetText();
            const PXR_NS::SdfPath materialPath = intToPath(hit.material);
...
//////////////////////////////////////////////////////////////////////////
    ...
    dev.def("get_materials_paths", [](const IPhysxUnitTests* self, const char* collider_path) {
        ...
        self->getMaterialsPaths(PXR_NS::SdfPath(collider_path), materialPaths);
        // Return as list
        py::list info;
    ...
    dev.def("setup_auto_deformable_attachment", [](const IPhysxAttachmentPrivate* self, const char* attachmentPath) {
        return self->setupAutoDeformableAttachment(PXR_NS::SdfPath(attachmentPath));
    ...
    dev.def("update_auto_deformable_attachment", [](const IPhysxAttachmentPrivate* self, const char* attachmentPath) {
        return self->updateAutoDeformableAttachment(PXR_NS::SdfPath(attachmentPath));
    }, docString, py::arg("attachment_path"));
    ...
    dev.def(
        ...
        [](const IPhysxAttachmentPrivate* self, const char* colliderPath, float samplingDistance) {
            ...
            PXR_NS::SdfPath colliderSdfPath(colliderPath);
