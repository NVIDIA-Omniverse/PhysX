...
void PhysXStatisticsBindings(pybind11::module& m)
{
    ...
    py::class_<PhysicsSceneStats>(m, "PhysicsSceneStats", R"(
        ...
        .def_readonly("gpu_mem_deformable_volume_contacts", &PhysicsSceneStats::gpuMemDeformableVolumeContacts, R"(Actual number of deformable volume contacts needed of Gpu Max Deformable Volume Contacts set with physxScene:gpuMaxDeformableVolumeContacts)")
