...
public:
     ...
     */
    virtual omni::physx::usdparser::PhysxDeformableBodyDesc* parseDeformableBody(PXR_NS::UsdPrim bodyPrim) = 0;
     ...
     */
    virtual void poissonSampleMesh(PXR_NS::UsdPrim& usdPrim,
