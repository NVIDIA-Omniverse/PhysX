...
CustomPhysXGeometryCallback* PhysXCustomGeometryManager::createCustomGeometry(const PXR_NS::SdfPath& primPath, const usdparser::CustomPhysxShapeDesc& customShapeDesc)
{
...
void PhysXCustomGeometryManager::removeCustomGeometry(const PXR_NS::SdfPath& primPath)
{
