...
using CustomGeometryTypeMap = std::unordered_map<PXR_NS::TfToken, CustomGeometryInfo, PXR_NS::TfToken::HashFunctor>;
...
public:
    ...
    CustomPhysXGeometryCallback* createCustomGeometry(const PXR_NS::SdfPath& primPath,
                                                      const usdparser::CustomPhysxShapeDesc& customShapeDesc);

    void removeCustomGeometry(const PXR_NS::SdfPath& primPath);
