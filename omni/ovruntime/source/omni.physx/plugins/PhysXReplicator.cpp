                                                      ...
                                                      ProcessReplicationData& processReplicationData) -> void
                    {
                        ...
                        case PxConcreteType::eARTICULATION_LINK:
                        {
                            ...
                            if (!useFabricReplicate)
                            {
                                ...
                                {
                                    CARB_LOG_INFO("Prim to replicate path not found. StageId: %llu, New prim path: %s, old prim path: %s, replicate path %s, newReplicatePath %s", stageId, newSdfPath.GetText(),
                            ...
                            else
                            {
                                if (objectType != PxConcreteType::eARTICULATION_LINK)
                                {
                                    ...
                                    const PXR_NS::GfMatrix4d* worldPose = stageRw.getAttributeRd<PXR_NS::GfMatrix4d>(
                                    ...
                                    {
                                        CARB_LOG_INFO("Expecting omni:fabric:worldMatrix on a prim path: %s", newSdfPath.GetText());
                                    }
                                }
                                else
                                {
