...
public:
    ...
    ::physx::PxTolerancesScale getDefaultTolerances(PXR_NS::UsdStageRefPtr stage);

    ///////////////////////////////////////////////////////////////////////////////////////
    // Cooking params
    ::physx::PxCookingParams getCookingParams(const ::physx::PxTolerancesScale& tolerances);
    ::physx::PxCookingParams getStageDefaultCookingParams(PXR_NS::UsdStageRefPtr stage)
    {
