...
namespace omni
{
    namespace tetfinder
    {
        ...
        void getClosestPoints(carb::Float3* closestPoints, float* dists, const carb::Float3* points, const uint32_t pointsSize, const PXR_NS::SdfPath& rigidPath)
        {
            ...
            PXR_NS::UsdPrim rigidPrim = OmniPhysX::getInstance().getStage()->GetPrimAtPath(rigidPath);
            GfMatrix4d mat = UsdGeomXformable(rigidPrim).ComputeLocalToWorldTransform(PXR_NS::UsdTimeCode::Default());
