...
ObjectId InternalDatabase::addRecord(PhysXType type, void* ptr, void* internalPtr, const PXR_NS::SdfPath& path)
{
...
ObjectId InternalDatabase::addRecordAtIndex(size_t index, PhysXType type, void* ptr, void* internalPtr, const PXR_NS::SdfPath& path)
{    
