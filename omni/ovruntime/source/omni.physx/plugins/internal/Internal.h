...
public:
    struct Record
    {
        ...
        __forceinline Record(void* ptr, PhysXType type, void* internalPtr, const PXR_NS::SdfPath& path)
    ...
    usdparser::ObjectId addRecord(PhysXType type, void* ptr, void* internalPtr, const PXR_NS::SdfPath& path);
    usdparser::ObjectId addRecordAtIndex(
        size_t index, PhysXType type, void* ptr, void* internalPtr, const PXR_NS::SdfPath& path);
