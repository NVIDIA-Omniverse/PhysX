...
using ActorInitialDataMap = std::unordered_map<PXR_NS::SdfPath, ActorInitialData, PXR_NS::SdfPath::Hash>;
...
public:
    ...
    PXR_NS::UsdPrim mParentXformPrim;
    PXR_NS::UsdPrim mInstancePrim;
    PXR_NS::SdfPath mXformOpTranslatePath;
    PXR_NS::SdfPath mXformOpOrientPath;
    PXR_NS::SdfPath mVelocityPath;
    PXR_NS::SdfPath mAngularVelocityPath;
    ...
    PXR_NS::SdfPath mSourceGPrimPath;

    PXR_NS::GfMatrix4d mParentWorldTransfInv;
    PXR_NS::GfMatrix4d mExtraTransfInv;
