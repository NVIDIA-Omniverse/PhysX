...
void InternalVehicle::restoreInitialProperties()
{
    if (mInitialControllerValues)
    {
        ...
        CARB_ASSERT(mInitialControllerValues->prim.HasAPI<PXR_NS::PhysxSchemaPhysxVehicleControllerAPI>());
        PXR_NS::PhysxSchemaPhysxVehicleControllerAPI controllerAPI(mInitialControllerValues->prim);
        const bool hasTankController = mInitialControllerValues->prim.HasAPI<PXR_NS::PhysxSchemaPhysxVehicleTankControllerAPI>();
        ...
        {
            PXR_NS::PhysxSchemaPhysxVehicleTankControllerAPI tankControllerAPI(mInitialControllerValues->prim);
...
void InternalVehicleWheelAttachment::restoreInitialProperties()
{
    ...
    {
        CARB_ASSERT(mInitialControllerValues.prim.HasAPI<PXR_NS::PhysxSchemaPhysxVehicleWheelControllerAPI>());
        PXR_NS::PhysxSchemaPhysxVehicleWheelControllerAPI controllerAPI(mInitialControllerValues.prim);
