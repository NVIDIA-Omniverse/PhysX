...
public:
    struct WheelTransformManagementEntry
    {
        ...
        PXR_NS::UsdPrim shapePrim; // invalid if there is no collision shape
    ...
    {
        PXR_NS::UsdPrim prim; // currently this is the only reason to store the prim
        float accelerator;
        float brake0;
        float brake1;
