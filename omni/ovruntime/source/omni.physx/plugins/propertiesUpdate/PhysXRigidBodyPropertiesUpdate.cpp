...
void applyPhysxProps(AttachedStage& attachedStage, PXR_NS::UsdPrim prim, PxRigidDynamic* rigidDynamic)
{
...
// physx body
bool updateRigidBody(bool force, AttachedStage& attachedStage, ObjectId objectId, const PXR_NS::TfToken& property, const PXR_NS::UsdTimeCode& timeCode)
{
    const OmniPhysX& omniPhysX = OmniPhysX::getInstance();
    const InternalPhysXDatabase& db = omniPhysX.getInternalPhysXDatabase();
...
bool omni::physx::updateBodyWorldForce(AttachedStage& attachedStage, ObjectId objectId, const PXR_NS::TfToken& property, const PXR_NS::UsdTimeCode& timeCode)
{
...
bool omni::physx::updateBodyWorldTorque(AttachedStage& attachedStage, ObjectId objectId, const PXR_NS::TfToken& property, const PXR_NS::UsdTimeCode& timeCode)
{
