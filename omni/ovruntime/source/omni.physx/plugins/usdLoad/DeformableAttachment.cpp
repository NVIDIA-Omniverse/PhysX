...
namespace usdparser
{
    PhysxDeformableAttachmentDesc* parseDeformableAttachment(const PXR_NS::UsdStageWeakPtr stage, const omni::physics::schema::AttachmentDesc& inDesc)
    {
    ...
    PhysxDeformableCollisionFilterDesc* parseDeformableCollisionFilter(const PXR_NS::UsdStageWeakPtr stage, const omni::physics::schema::ElementCollisionFilterDesc& inDesc)
    {
