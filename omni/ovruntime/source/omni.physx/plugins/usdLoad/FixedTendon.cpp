...
namespace usdparser
{
    ...
    {
        const PXR_NS::UsdAttribute& gearingAttr = axisApi.GetGearingAttr();
        {
            const PXR_NS::UsdAttribute& forceCoefficientAttr = axisApi.GetForceCoefficientAttr();
            VtFloatArray temp;
        ...
        {
            TfToken axis = PXR_NS::UsdPhysicsTokens.Get()->none;
