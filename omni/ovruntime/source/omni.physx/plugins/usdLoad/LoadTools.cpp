                   ...
                   const PXR_NS::UsdPrim& jointPrim)
{
    ...
    PXR_NS::UsdPrim localFramePrim = stage->GetPrimAtPath(targets.at(0));
    ...
    if (!localFramePrim.IsA<PXR_NS::UsdGeomXformable>())
    {
    ...
    PXR_NS::UsdGeomXformable xform(localFramePrim);
