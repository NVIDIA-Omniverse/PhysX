...
void setToDefault(UsdStageWeakPtr stage, PhysxDeformableMaterialDesc& desc)
{
    ...
    double kilogramsPerUnit = PXR_NS::UsdPhysicsGetStageKilogramsPerUnit(stage);
...
void parseMaterialDescInt(const PXR_NS::UsdStageWeakPtr stage, const omni::physics::schema::MaterialDesc& inDesc, PhysxMaterialDesc& materialDesc)
{
...
PhysxMaterialDesc* parseMaterialDesc(const PXR_NS::UsdStageWeakPtr stage, const omni::physics::schema::MaterialDesc& inDesc)
{
...
void parseDeformableMaterialDescInt(const PXR_NS::UsdStageWeakPtr /*stage*/,
...
void parseSurfaceDeformableMaterialDescInt(const PXR_NS::UsdStageWeakPtr stage,
...
PhysxDeformableMaterialDesc* parseDeformableMaterialDesc(const PXR_NS::UsdStageWeakPtr stage, const omni::physics::schema::DeformableMaterialDesc& inDesc)
{
...
void parsePBDMaterialForPrim(const PXR_NS::UsdPrim& usdPrim, const SdfPath& materialPath, PBDMaterialDesc& desc)
{
    setToDefault(desc);
...
void parseDeformableMaterialForPrim(const PXR_NS::UsdPrim& usdPrim, const SdfPath& materialPath, PhysxDeformableMaterialDesc& desc)
{
...
void parseSurfaceDeformableMaterialForPrim(const PXR_NS::UsdPrim& usdPrim, const SdfPath& materialPath, PhysxSurfaceDeformableMaterialDesc& desc)
{
    UsdStageWeakPtr stage = usdPrim.GetStage();
    setToDefault(stage, desc);
...
void parseMaterialForPrim(const PXR_NS::UsdPrim& usdPrim, const SdfPath& materialPath, PhysxMaterialDesc& desc)
{
    setToDefault(desc);
