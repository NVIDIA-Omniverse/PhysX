...
public:
    ...
    void parsePrim(const PXR_NS::UsdPrim& prim, omni::physics::schema::ObjectDesc* objectDesc, uint64_t, const PXR_NS::TfTokenVector& appliedApis) override
    {
    }

    void reportObjectDesc(const PXR_NS::SdfPath& path, const omni::physics::schema::ObjectDesc* objectDesc) override
    {
    ...
    void parse()
    {
        ...
        {
            PXR_NS::UsdPrimRange range(prim, UsdTraverseInstanceProxies(PXR_NS::UsdPrimIsActive && PXR_NS::UsdPrimIsLoaded && !PXR_NS::UsdPrimIsAbstract));
...
public:
    ...
    void parsePrim()
    {
        IUsdPhysics* usdPhysics = carb::getCachedInterface<IUsdPhysics>();
        usdPhysics->registerPhysicsListener(this);        
        PXR_NS::UsdPrimRange range(usdPrim, UsdTraverseInstanceProxies(PXR_NS::UsdPrimIsActive && PXR_NS::UsdPrimIsLoaded && !PXR_NS::UsdPrimIsAbstract));
        UsdGeomXformCache xfCache;
        omni::physics::schema::PrimIteratorRange primIteratorRange(range);
