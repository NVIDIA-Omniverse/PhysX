...
public:
    ...
    void setupScenePartition(const PXR_NS::SdfPath& envPath, uint32_t envIndex);

    void clone(const PXR_NS::SdfPath& envPath, const PXR_NS::SdfPath& sourceEnvPath,  uint32_t numEnvs, uint32_t numCols, float offset);
