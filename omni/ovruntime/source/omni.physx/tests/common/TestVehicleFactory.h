...
public:
    ...
    struct Car4WheelsParams
    {
        ...
        AxesIndices axes;
        const PXR_NS::SdfPath(*wheelPaths)[4];
        const PXR_NS::SdfPath(*tirePaths)[4];
        const PXR_NS::SdfPath(*suspensionPaths)[4];
        const PXR_NS::SdfPath* drivePath;
        PXR_NS::SdfPath(*wheelAttachmentPathsOut)[4];
        bool enabled;
        bool useRaycasts;
    ...
    struct Car4WheelsScenarioParams
    {
        ...
        PXR_NS::SdfPath* vehiclePathsOut;
        PXR_NS::SdfPath(*wheelAttachmentPathsOut)[WheelAttId::eCOUNT];
    ...
    static void createCollisionGroups(
        ...
        PXR_NS::SdfPath(*collisionGroupPathsOut)[CollGroupId::eCOUNT] = nullptr
    );

    static void createMaterialsAndTireFrictionTables(
        const PXR_NS::UsdStageRefPtr&,
        PXR_NS::SdfPath(*materialPathsOut)[MaterialId::eCOUNT] = nullptr,
        PXR_NS::SdfPath(*tireFrictionTablePathsOut)[TireFrictionTableId::eCOUNT] = nullptr
    );
    ...
    static void create4WheeledCar(
        ...
        const PXR_NS::SdfPath* tireFrictionTablePath = nullptr,
        const PXR_NS::SdfPath* chassisCollisionGroupPath = nullptr,
        const PXR_NS::SdfPath* wheelCollisionGroupPath = nullptr,
