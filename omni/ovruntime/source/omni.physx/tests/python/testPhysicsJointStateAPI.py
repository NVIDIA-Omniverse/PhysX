...
#
# Ported from omni.physx.tests PhysicsJointStateAPI.py for standalone ovruntime testing.
...
class PhysicsJointStateAPITestMemoryStage(PhysicsMemoryStageBaseTestCase, ArticulationTestBase):
    ...
    def test_articulation_revolute_joint_state(self):
    ...
    def test_articulation_revolute_joint_state_save_restore(self):
        ...
        self.new_stage(def_up_and_mpu=False, file_to_load=filename)
    ...
    def test_articulation_joint_state_D6_translation_error(self):
        self._setup_two_link_articulation()
