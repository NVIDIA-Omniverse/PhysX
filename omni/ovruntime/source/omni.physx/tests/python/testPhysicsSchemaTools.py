...
#
# Ported from omni.physx.tests PhysicsSchemaTools.py for standalone ovruntime testing.
...
class PhysicsSchemaToolsTestMemoryStage(PhysicsMemoryStageBaseTestCase):
    category = TestCategory.Core

    def test_physics_schema_tools(self):
