...
#
# Ported from omni.physx.tests PhysicsUtils.py for standalone ovruntime testing.
...
def rigid_box_setup(stage):
    ...
    physicsUtils.add_rigid_box(
        stage, cubePath, Gf.Vec3f(size, size, size),
        position, orientation, color, density, linVelocity, angularVelocity,
    )
...
class PhysicsUtilsTestMemoryStage(PhysicsMemoryStageBaseTestCase):
    category = TestCategory.Core

    def test_physics_utils(self):
        ...
        self.step()
        check_stats(self, {"numPlaneShapes": 1, "numStaticRigids": 1, "numDynamicRigids": 0})

        rigid_box_setup(stage)
        self.step()
        check_stats(self, {"numPlaneShapes": 1, "numBoxShapes": 1, "numStaticRigids": 1, "numDynamicRigids": 1})

        rigid_sphere_setup(stage)
        self.step()
        check_stats(self, {"numPlaneShapes": 1, "numBoxShapes": 1, "numSphereShapes": 1, "numStaticRigids": 1, "numDynamicRigids": 2})

        rigid_capsule_setup(stage)
        self.step()
        check_stats(self, {"numPlaneShapes": 1, "numBoxShapes": 1, "numSphereShapes": 1, "numCapsuleShapes": 1, "numStaticRigids": 1, "numDynamicRigids": 3})

        rigid_cylinder_setup(stage)
        self.step()
        check_stats(self, {"numPlaneShapes": 1, "numBoxShapes": 1, "numSphereShapes": 1, "numCapsuleShapes": 1, "numCylinderShapes": 1, "numStaticRigids": 1, "numDynamicRigids": 4})

        rigid_cone_setup(stage)
        self.step()
        check_stats(self, {"numPlaneShapes": 1, "numBoxShapes": 1, "numSphereShapes": 1, "numCapsuleShapes": 1, "numCylinderShapes": 1, "numConeShapes": 1, "numStaticRigids": 1, "numDynamicRigids": 5})

    def test_compute_bounding_box_diagonal(self):
    ...
    def test_cylinder_mesh(self):
        ...
        self.step()
        check_stats(self, {"numConvexShapes": 1, "numStaticRigids": 1})
    ...
    def test_cube_ground_plane(self):
        stage = self.new_stage()
        ...
        self.step()
        check_stats(self, {"numBoxShapes": 1, "numStaticRigids": 1})

    def test_collision_group_utils(self):
        stage = self.new_stage()
    ...
    def test_add_joint_fixed_utils(self):
        stage = self.new_stage()
