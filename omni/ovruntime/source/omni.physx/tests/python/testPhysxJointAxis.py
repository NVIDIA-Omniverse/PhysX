...
#
# Ported from omni.physx.tests PhysxJointAxis.py for standalone ovruntime testing.
...
JOINT_AXIS_API = _physx.JOINT_AXIS_API
JOINT_AXIS_ATTR_ARMATURE_ANGULAR = _physx.JOINT_AXIS_ATTR_ARMATURE_ANGULAR
JOINT_AXIS_ATTR_ARMATURE_LINEAR = _physx.JOINT_AXIS_ATTR_ARMATURE_LINEAR
JOINT_AXIS_ATTR_ARMATURE_ROTX = _physx.JOINT_AXIS_ATTR_ARMATURE_ROTX
JOINT_AXIS_ATTR_ARMATURE_ROTY = _physx.JOINT_AXIS_ATTR_ARMATURE_ROTY
JOINT_AXIS_ATTR_ARMATURE_ROTZ = _physx.JOINT_AXIS_ATTR_ARMATURE_ROTZ
JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ANGULAR = _physx.JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ANGULAR
JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_LINEAR = _physx.JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_LINEAR
JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTX = _physx.JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTX
JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTY = _physx.JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTY
JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTZ = _physx.JOINT_AXIS_ATTR_MAX_JOINT_VELOCITY_ROTZ
JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ANGULAR = _physx.JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ANGULAR
JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_LINEAR = _physx.JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_LINEAR
JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTX = _physx.JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTX
JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTY = _physx.JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTY
JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTZ = _physx.JOINT_AXIS_ATTR_STATIC_FRICTION_EFFORT_ROTZ
JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ANGULAR = _physx.JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ANGULAR
JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_LINEAR = _physx.JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_LINEAR
JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTX = _physx.JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTX
JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTY = _physx.JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTY
JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTZ = _physx.JOINT_AXIS_ATTR_DYNAMIC_FRICTION_EFFORT_ROTZ
JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ANGULAR = _physx.JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ANGULAR
JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_LINEAR = _physx.JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_LINEAR
JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTX = _physx.JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTX
JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTY = _physx.JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTY
JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTZ = _physx.JOINT_AXIS_ATTR_VISCOUS_FRICTION_COEFFICIENT_ROTZ
...
class PhysxJointAxisAPITestMemoryStage(PhysicsMemoryStageBaseTestCase, ArticulationTestBase):
    ...
    def _run_test_physx_joint_api_armature(self, stage: Usd.Stage, jointType: int) -> None:
        ...
        # Case 1
        self._applyJointAxisAPI(childLinkInboundJointPrim, jointType)
        jointStateAPI.GetPositionAttr().Set(self._scalePositionToDegreesAsNecessary(jointType, 0.0))
        jointStateAPI.GetVelocityAttr().Set(self._scaleVelocityToDegreesAsNecessary(jointType, 0.0))
        ...
        self._simulate_one_frame_with_prep()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(1.0 - measuredJointSpeed), permittedErrorSmallArmature[jointType])
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        #self.assertLess(abs(0.1 - measuredJointSpeed), permittedErrorLargeArmature[jointType])
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(5.0 - measuredJointSpeed), 0.5)
    ...
    def _run_test_physx_joint_api_static_friction(self, stage: Usd.Stage, jointType: int) -> None:
        ...
        self._simulate_one_frame_with_prep()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(0.0 - measuredJointSpeed), 0.02)
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(1 - measuredJointSpeed), permittedErrorSmallFriction[jointType])
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(1.0 - measuredJointSpeed), permittedErrorSmallFriction[jointType])
    ...
    def _run_test_physx_joint_api_dynamic_friction(self, stage: Usd.Stage, jointType: int) -> None:
        ...
        self._applyJointAxisAPI(childLinkInboundJointPrim, jointType)
        jointStateAPI.GetPositionAttr().Set(self._scalePositionToDegreesAsNecessary(jointType, 0.0))
        jointStateAPI.GetVelocityAttr().Set(self._scaleVelocityToDegreesAsNecessary(jointType, 1.0))
        self._setJointAxisAttribute(childLinkInboundJointPrim, jointType, JOINT_AXIS_ATTR_STATIC_FRICTION, 100.0)
        self._setJointAxisAttribute(childLinkInboundJointPrim, jointType, JOINT_AXIS_ATTR_DYNAMIC_FRICTION, 100.0)
        physxJointAPI.GetJointFrictionAttr().Set(0.0)
        self._simulate_one_frame_with_prep()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(1.0 - measuredJointSpeed), permittedError[jointType])
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(2.0 - measuredJointSpeed), permittedError[jointType])
    ...
    def _run_test_physx_joint_api_viscous_friction(self, stage: Usd.Stage, jointType: int) -> None:
        ...
        self._applyJointAxisAPI(childLinkInboundJointPrim, jointType)
        jointStateAPI.GetPositionAttr().Set(self._scalePositionToDegreesAsNecessary(jointType, 0.0))
        jointStateAPI.GetVelocityAttr().Set(self._scaleVelocityToDegreesAsNecessary(jointType, 9.0))
        self._setJointAxisAttribute(childLinkInboundJointPrim, jointType, JOINT_AXIS_ATTR_STATIC_FRICTION, 100.0)
        ...
        self._simulate_one_frame_with_prep()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(5.0 - measuredJointSpeed), 0.1)
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(10.0 - measuredJointSpeed), 0.2)
        ...
        self._simulate_one_frame()
        measuredJointSpeed = self._scaleVelocityToRadiansAsNecessary(jointType, jointStateAPI.GetVelocityAttr().Get())
        self.assertLess(abs(2.0 - measuredJointSpeed), 0.2)


    def _run_test_apply_physx_joint_api_warnings(self, jointType: int):
    ...
    def test_apply_physx_joint_api_dynamic_friction_revolute_x(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_REVOLUTE_X)

    def test_apply_physx_joint_api_dynamic_friction_revolute_y(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_REVOLUTE_Y)

    def test_apply_physx_joint_api_dynamic_friction_revolute_z(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_REVOLUTE_Z)

    def test_apply_physx_joint_api_dynamic_friction_prismatic_x(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_PRISMATIC_X)

    def test_apply_physx_joint_api_dynamic_friction_prismatic_y(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_PRISMATIC_Y)

    def test_apply_physx_joint_api_dynamic_friction_prismatic_z(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_PRISMATIC_Z)

    def test_apply_physx_joint_api_dynamic_friction_spherical_x(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_SPHERICAL_ROTX)

    def test_apply_physx_joint_api_dynamic_friction_spherical_y(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_SPHERICAL_ROTY)

    def test_apply_physx_joint_api_dynamic_friction_spherical_z(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_dynamic_friction(stage, JOINT_TYPE_SPHERICAL_ROTZ)

    #################################################

    def test_apply_physx_joint_api_viscous_friction_revolute_x(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_REVOLUTE_X)

    def test_apply_physx_joint_api_viscous_friction_revolute_y(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_REVOLUTE_Y)

    def test_apply_physx_joint_api_viscous_friction_revolute_z(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_REVOLUTE_Z)

    def test_apply_physx_joint_api_viscous_friction_prismatic_x(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_PRISMATIC_X)

    def test_apply_physx_joint_api_viscous_friction_prismatic_y(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_PRISMATIC_Y)

    def test_apply_physx_joint_api_viscous_friction_prismatic_z(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_PRISMATIC_Z)

    def test_apply_physx_joint_api_viscous_friction_spherical_x(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_SPHERICAL_ROTX)

    def test_apply_physx_joint_api_viscous_friction_spherical_y(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_SPHERICAL_ROTY)

    def test_apply_physx_joint_api_viscous_friction_spherical_z(self):
        stage = self.new_stage()
        self._run_test_physx_joint_api_viscous_friction(stage, JOINT_TYPE_SPHERICAL_ROTZ)

    #################################################

    def test_apply_physx_joint_api_revolute_joint_warnings(self):
        self._run_test_apply_physx_joint_api_warnings(JOINT_TYPE_REVOLUTE_X)

    def test_apply_physx_joint_api_prismatic_joint_warnings(self):
        self._run_test_apply_physx_joint_api_warnings(JOINT_TYPE_PRISMATIC_X)
