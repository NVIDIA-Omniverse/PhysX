          ...
          "[component=OmniPhysics][owner=preist][priority=mandatory]")
{
    ...
    PXR_NS::UsdGeomSetStageMetersPerUnit(stage, static_cast<double>(metersPerStageUnit));
    ...
    SUBCASE("Multiple articulations with Fixed Joint") // OM-84752
    {
        ...
        fixedJointBetweenArticulations.CreateLocalPos0Attr().Set(PXR_NS::GfVec3f(0.5f, 0.0f, 0.0f));
        fixedJointBetweenArticulations.CreateLocalPos1Attr().Set(PXR_NS::GfVec3f(-0.5f, 0.0f, 0.0f));
        ...
        fixedJointBetweenArticulations.GetLocalPos0Attr().Set(PXR_NS::GfVec3f(1.5f, 0.0f, 0.0f));
        fixedJointBetweenArticulations.GetLocalPos1Attr().Set(PXR_NS::GfVec3f(-0.5f, 0.0f, 0.0f));
        physxSim->simulate(0.01f, 0.0f);
        physxSim->fetchResults();
        {
            PxTransform articulation2GlobalPose =  pxArticulation2->getRootGlobalPose();
