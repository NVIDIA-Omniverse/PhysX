...
GfMatrix4d computeMatrix(const PXR_NS::GfVec3d& translate, const PXR_NS::GfMatrix3d& rotate, const PXR_NS::GfVec3d& scale)
{
          ...
          "[component=OmniPhysics][owner=adenzler][priority=mandatory]")
{
    ...
    std::vector<PXR_NS::GfMatrix4d> worldMatrices;
    ...
    for (int i = 0; i < paths.size(); ++i)
    {
        ...
        // transform
        {
            ...
            const PXR_NS::GfMatrix4d mat = *fabricStage.getAttributeRd<PXR_NS::GfMatrix4d>(fabricPath, worldMatrixToken);
            
            PXR_NS::GfVec3d pos = mat.ExtractTranslation();
            PXR_NS::GfVec3d refpos = worldMatrices[i].ExtractTranslation();
