...
public:
    struct Entry
    {
        Entry(PXR_NS::SdfPath inPath, omni::physx::usdparser::ObjectId inObjectId, omni::physx::PhysXType inType)
            : path(inPath)
            , objectId(inObjectId)
            , type(inType)
        {
    ...
    static void onCreation(const PXR_NS::SdfPath& sdfPath, omni::physx::usdparser::ObjectId objectId,
    ...
    static void onDestruction(const PXR_NS::SdfPath& sdfPath, omni::physx::usdparser::ObjectId objectId,
        omni::physx::PhysXType type, void* userData)
    {
        ObjectChangeNotifier& ocn = *reinterpret_cast<ObjectChangeNotifier*>(userData);
    ...
    "[component=OmniPhysics][owner=msauter][priority=mandatory]")
{
    ...
    const PXR_NS::SdfPath physicsScenePath = defaultPrimPath.AppendChild(PXR_NS::TfToken("physicsScene"));
    PXR_NS::UsdPhysicsScene scene = PXR_NS::UsdPhysicsScene::Define(stage, physicsScenePath);

    const PXR_NS::SdfPath box0Path = defaultPrimPath.AppendChild(PXR_NS::TfToken("box0"));
    addRigidBox(stage, box0Path.GetText(), PXR_NS::GfVec3f(100.f), PXR_NS::GfVec3f(0.0f), PXR_NS::GfQuatf(1.0f),
        PXR_NS::GfVec3f(0.7f), 0.001f);
    ...
    //
    const PXR_NS::SdfPath box1Path = defaultPrimPath.AppendChild(PXR_NS::TfToken("box1"));
    addRigidBox(stage, box1Path.GetText(), PXR_NS::GfVec3f(100.f), PXR_NS::GfVec3f(10.0f), PXR_NS::GfQuatf(1.0f),
        PXR_NS::GfVec3f(0.7f), 0.001f);
    ...
    //
    PXR_NS::UsdPrim box1Prim = stage->GetPrimAtPath(box1Path);
    box1Prim.RemoveAPI<PXR_NS::UsdPhysicsRigidBodyAPI>();
    ...
    //
    box1Prim.RemoveAPI<PXR_NS::UsdPhysicsCollisionAPI>();
    ...
    //
    PXR_NS::UsdPhysicsRigidBodyAPI::Apply(box1Prim);
    ...
    const PXR_NS::SdfPath box2Path = defaultPrimPath.AppendChild(PXR_NS::TfToken("box2"));
    addRigidBox(stage, box2Path.GetText(), PXR_NS::GfVec3f(100.f), PXR_NS::GfVec3f(20.0f), PXR_NS::GfQuatf(1.0f),
        PXR_NS::GfVec3f(0.7f), 0.001f);
    ...
    //
    const PXR_NS::SdfPath box3Path = defaultPrimPath.AppendChild(PXR_NS::TfToken("box3"));
    addRigidBox(stage, box3Path.GetText(), PXR_NS::GfVec3f(100.f), PXR_NS::GfVec3f(30.0f), PXR_NS::GfQuatf(1.0f),
        PXR_NS::GfVec3f(0.7f), 0.001f);
