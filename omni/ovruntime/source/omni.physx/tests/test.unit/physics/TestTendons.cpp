...
// Helper methods
static PXR_NS::PhysxSchemaPhysxTendonAttachmentRootAPI setupSpatialRootAtPath(const UsdStageWeakPtr stage,
                                                                           const SdfPath xformPath,
                                                                           const TfToken instanceName)
{
    PXR_NS::UsdPrim rootPrim = stage->GetPrimAtPath(xformPath);
    PXR_NS::PhysxSchemaPhysxTendonAttachmentRootAPI rootApi =
        PXR_NS::PhysxSchemaPhysxTendonAttachmentRootAPI::Apply(rootPrim, instanceName);
...
static PXR_NS::PhysxSchemaPhysxTendonAttachmentAPI setupSpatialAttachmentAtPath(const UsdStageWeakPtr stage,
                                                                             const SdfPath xformPath,
                                                                             const TfToken instanceName,
                                                                             const SdfPath parentPath,
                                                                             const TfToken parentInstance)
{
    PXR_NS::UsdPrim attachPrim = stage->GetPrimAtPath(xformPath);
    PXR_NS::PhysxSchemaPhysxTendonAttachmentAPI attachApi =
        PXR_NS::PhysxSchemaPhysxTendonAttachmentAPI::Apply(attachPrim, instanceName);
...
static PXR_NS::PhysxSchemaPhysxTendonAttachmentLeafAPI setupSpatialLeafAtPath(const UsdStageWeakPtr stage,
                                                                           const SdfPath xformPath,
                                                                           const TfToken instanceName,
                                                                           const SdfPath parentPath,
                                                                           const TfToken parentInstance)
{
    PXR_NS::UsdPrim leafPrim = stage->GetPrimAtPath(xformPath);
    PXR_NS::PhysxSchemaPhysxTendonAttachmentLeafAPI leafApi =
        PXR_NS::PhysxSchemaPhysxTendonAttachmentLeafAPI::Apply(leafPrim, instanceName);
...
static PXR_NS::PhysxSchemaPhysxTendonAxisRootAPI setupFixedTendonRoot(const UsdStageWeakPtr stage,
                                                                   const SdfPath jointPath,
                                                                   const TfToken tendonName)
{
    PXR_NS::UsdPrim rootPrim = stage->GetPrimAtPath(jointPath);
    PXR_NS::PhysxSchemaPhysxTendonAxisRootAPI rootApi = PXR_NS::PhysxSchemaPhysxTendonAxisRootAPI::Apply(rootPrim, tendonName);
...
static PXR_NS::PhysxSchemaPhysxTendonAxisAPI setupFixedTendonAxis(const UsdStageWeakPtr stage,
                                                               const SdfPath jointPath,
                                                               const TfToken tendonName)
{
    PXR_NS::UsdPrim attachPrim = stage->GetPrimAtPath(jointPath);
    PXR_NS::PhysxSchemaPhysxTendonAxisAPI axisApi = PXR_NS::PhysxSchemaPhysxTendonAxisAPI::Apply(attachPrim, tendonName);
          ...
          "[component=OmniPhysics][owner=preist][priority=mandatory]")
{
    ...
    PXR_NS::UsdGeomXform xform = PXR_NS::UsdGeomXform::Define(stage, xformPrimPath);
    ...
    for (size_t i = 1; i < 5; ++i)
    {
        ...
        PXR_NS::SdfPath jointPath = xformPrimPath.AppendChild(TfToken(jointString));
    ...
    {
        // setup fixed tendon
        PXR_NS::PhysxSchemaPhysxTendonAxisRootAPI rootApi = setupFixedTendonRoot(stage, mainJoints.at(2), TfToken("t1"));
    ...
    SUBCASE("Branching")
    {
        ...
        SUBCASE("Spatial Tendon")
        {
            ...
            const PXR_NS::PhysxSchemaPhysxTendonAttachmentLeafAPI leafApi =
          ...
          "[component=OmniPhysics][owner=aborovicka][priority=mandatory]")
{
    ...
    SUBCASE("Articulation links consistency")
    {
        ...
        PXR_NS::UsdPrimRange range = stage->Traverse();
