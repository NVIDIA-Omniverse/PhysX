...
static SdfPath GetRel(const PXR_NS::UsdRelationship& ref, const PXR_NS::UsdPrim& jointPrim)
{
...
PXR_NS::UsdPrim getBodyPrim(const PXR_NS::UsdStageWeakPtr stage, const PXR_NS::SdfPath& relPath, PXR_NS::UsdPrim& relPrim)
{
...
SdfPath getLocalPose(const PXR_NS::UsdStageWeakPtr stage,
    PXR_NS::UsdGeomXformCache& xfCache, const SdfPath& relPath, GfVec3f& t, GfQuatf& q)
{
    UsdPrim relPrim;    
...
void finalizeJoint(const PXR_NS::UsdStageWeakPtr stage, JointDesc* jointDesc,
    PXR_NS::UsdGeomXformCache& xfCache)
{
    // joint bodies anchor point local transforms
    PXR_NS::UsdPhysicsJoint jointPrim(jointDesc->usdPrim);
    GfVec3f t0(0.f);
    GfVec3f t1(0.f);
    GfQuatf q0(1.f);
    GfQuatf q1(1.f);
