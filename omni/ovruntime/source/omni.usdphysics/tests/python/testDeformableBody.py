...
class UsdPhysicsDeformableBodyTest(UsdPhysicsBaseTest):
    ...
    def test_volume_deformable_body(self):
        self.expected_prims = {}
        ...
        self.parse("DeformableBody")


    def test_surface_deformable_body(self):
        self.expected_prims = {}
    ...
    def test_volume_deformable_body_material(self):
        self.expected_prims = {}
        ...
        self.parse("DeformableBodyMaterial")


    def test_surface_deformable_body_material(self):
        self.expected_prims = {}
