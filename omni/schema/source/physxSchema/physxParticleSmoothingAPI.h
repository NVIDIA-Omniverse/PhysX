...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXPARTICLESMOOTHINGAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXPARTICLESMOOTHINGAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxParticleSmoothingAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxParticleSmoothingAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxParticleSmoothingAPI
