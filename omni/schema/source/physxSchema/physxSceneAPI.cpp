...
UsdAttribute
PhysxSchemaPhysxSceneAPI::GetSolveArticulationContactLastAttr() const
{
    return GetPrim().GetAttribute(PhysxSchemaTokens->physxSceneSolveArticulationContactLast);
}

UsdAttribute
PhysxSchemaPhysxSceneAPI::CreateSolveArticulationContactLastAttr(VtValue const &defaultValue, bool writeSparsely) const
{
...
UsdAttribute
PhysxSchemaPhysxSceneAPI::GetDisableSleepingAttr() const
{
    return GetPrim().GetAttribute(PhysxSchemaTokens->physxSceneDisableSleeping);
}

UsdAttribute
PhysxSchemaPhysxSceneAPI::CreateDisableSleepingAttr(VtValue const &defaultValue, bool writeSparsely) const
{
