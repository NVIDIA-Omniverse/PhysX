...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXSCENEQUASISTATICAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXSCENEQUASISTATICAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxSceneQuasistaticAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxSceneQuasistaticAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxSceneQuasistaticAPI
