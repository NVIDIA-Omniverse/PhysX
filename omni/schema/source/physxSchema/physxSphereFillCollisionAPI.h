...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXSPHEREFILLCOLLISIONAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXSPHEREFILLCOLLISIONAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxSphereFillCollisionAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxSphereFillCollisionAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxSphereFillCollisionAPI
