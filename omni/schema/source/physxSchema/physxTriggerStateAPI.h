...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXTRIGGERSTATEAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXTRIGGERSTATEAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxTriggerStateAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxTriggerStateAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxTriggerStateAPI
