...
static UsdAttribute
_CreateNaturalFrequencyAttr(PhysxSchemaPhysxMimicJointAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateNaturalFrequencyAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Float), writeSparsely);
}
        
static UsdAttribute
_CreateDampingRatioAttr(PhysxSchemaPhysxMimicJointAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateDampingRatioAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Float), writeSparsely);
}
...
void wrapPhysxSchemaPhysxMimicJointAPI()
{
    ...
    cls
        ...
        .def("GetNaturalFrequencyAttr",
             &This::GetNaturalFrequencyAttr)
        .def("CreateNaturalFrequencyAttr",
             &_CreateNaturalFrequencyAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
        
        .def("GetDampingRatioAttr",
             &This::GetDampingRatioAttr)
        .def("CreateDampingRatioAttr",
             &_CreateDampingRatioAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
