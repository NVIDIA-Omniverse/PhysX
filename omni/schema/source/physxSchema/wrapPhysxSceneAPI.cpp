...
static UsdAttribute
_CreateSolveArticulationContactLastAttr(PhysxSchemaPhysxSceneAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateSolveArticulationContactLastAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Bool), writeSparsely);
}
...
static UsdAttribute
_CreateDisableSleepingAttr(PhysxSchemaPhysxSceneAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateDisableSleepingAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Bool), writeSparsely);
}
...
void wrapPhysxSchemaPhysxSceneAPI()
{
    ...
    cls
        ...
        .def("GetSolveArticulationContactLastAttr",
             &This::GetSolveArticulationContactLastAttr)
        .def("CreateSolveArticulationContactLastAttr",
             &_CreateSolveArticulationContactLastAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
        ...
        .def("GetDisableSleepingAttr",
             &This::GetDisableSleepingAttr)
        .def("CreateDisableSleepingAttr",
             &_CreateDisableSleepingAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
