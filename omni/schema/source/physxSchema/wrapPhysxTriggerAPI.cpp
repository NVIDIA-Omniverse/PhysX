...
_Repr(const PhysxSchemaPhysxTriggerAPI &self)
{
    ...
    return TfStringPrintf(
        "PhysxSchema.PhysxTriggerAPI(%s)",
        primRepr.c_str());
}

struct PhysxSchemaPhysxTriggerAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    PhysxSchemaPhysxTriggerAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static PhysxSchemaPhysxTriggerAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = PhysxSchemaPhysxTriggerAPI::CanApply(prim, &whyNot);
    return PhysxSchemaPhysxTriggerAPI_CanApplyResult(result, whyNot);
}

} // anonymous namespace

void wrapPhysxSchemaPhysxTriggerAPI()
{
    typedef PhysxSchemaPhysxTriggerAPI This;

    PhysxSchemaPhysxTriggerAPI_CanApplyResult::Wrap<PhysxSchemaPhysxTriggerAPI_CanApplyResult>(
