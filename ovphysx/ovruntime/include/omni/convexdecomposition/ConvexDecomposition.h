...
struct ConvexDecomposition
{
    ...
    ConvexDecomposition(const ConvexDecomposition&) = delete;
    ConvexDecomposition& operator=(const ConvexDecomposition&) = delete;
    ConvexDecomposition(ConvexDecomposition&&) = delete;
    ConvexDecomposition& operator=(ConvexDecomposition&&) = delete;
