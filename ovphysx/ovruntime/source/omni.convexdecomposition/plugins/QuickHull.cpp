...
// fixup the input vertices to be not colinear or coplanar for the initial simplex find
        ...
        QuickHullVertex* maximumVertex, double& tolerance, double& planeTolerance)
    {
        ...
        // Silences an uninitialized-variable warning: the compiler can't prove
        // if(lengSqr > maxDist) below will execute at least once to write simplex[2]/simplex[3].
        simplex[2] = simplex[0];
        simplex[3] = simplex[1];
...
//TODO:    mPlaneTolerance = QhMax(mCookingParams.planeTolerance * sizeTol, mCookingParams.planeTolerance);
}
...
// TODO: re-add plane shifting vertex limit check
