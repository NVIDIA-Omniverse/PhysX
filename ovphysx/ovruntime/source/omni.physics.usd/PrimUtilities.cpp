...
namespace primutils
{
    ...
    {
        // Element copy, not a transpose: PxMat44d and GfMatrix4d hold the same
        // sixteen doubles for the same transform.
        auto toMatrix4d = [](const ::physx::PxMat44d& m) {
        ...
        const PXR_NS::GfTransform body0tm =
            getJointBodyTransform(toMatrix4d(body0World), body0Valid, localPose0Position, localPose0Orientation);
        const PXR_NS::GfTransform body1tm =
            getJointBodyTransform(toMatrix4d(body1World), body1Valid, localPose1Position, localPose1Orientation);
