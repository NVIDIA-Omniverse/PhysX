...
// Genuine USD-authoring-only functionality: snapshots/restores the exact xform-op stack of a
// live USD prim across a simulation start/stop cycle -- no ovstage equivalent. Lives in the USD
// backend module (mirrors UsdXformHelpers.h/UsdPhysicsDataWrite.h) so omni.physx's
// internal::XformOpResetStorage stays pxr-free in OvruntimePhysX.
