...
public:
    ...
    */
    virtual void performTask(void) final
    {
        ...
        bool thicknessAdjusted = CookingTask::checkMeshThickness(m_desc.minThickness);
        ...
        // Bounding box of the source mesh, used by the 'explode view' debug
        // visualization to compute the offset between source mesh center and
        // convex hull center.
        ...
        mConvexDecomposition.saveOBJ("d:\\source-mesh.obj",sm,false);
#endif
        ...
        mConvexDecomposition.computeVHACD(cd, cdParam, sm);
        delete[]dvertices;
        ...
        else
        {
...
#endif
            // Process each convex hull produced by the decomposition
            bool validConvex = false;
            const PxU32 cdNumConvexes = mConvexDecomposition.getConvexHullCount(cd);
            ...
            for (PxU32 c = 0; c < cdNumConvexes; c++)
            {
                ...
                mConvexDecomposition.getConvexHull(cd, c, convexHull);
...
CookingTask* createConvexDecompositionCookingTask(const omni::physx::ConvexDecompositionCookingParams& desc,
                                                  ...
                                                  omni::convexdecomposition::ConvexDecomposition& convexDecomposition)
{
    return new ConvexDecompositionCookingTask(desc, result, convexDecomposition);
}
