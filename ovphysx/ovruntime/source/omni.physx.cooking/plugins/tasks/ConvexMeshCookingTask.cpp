...
public:
        ...
        : CookingTask(result)
    {
        ...
        m_signScale = convexCookingParams.signScale;
    }
    ...
    */
    virtual void performTask(void) final
    {
        ...
        // Detect coplanar and/or tiny meshes and make sure they meet the 'm_minThickness' requirement
        ...
        // Pass the source vertices to the physx cooking library and store the results in the output stream
    ...
    */
    virtual void finalize(void) final
    {
        ...
        else
        {
            ...
            // Save the triangulation here rather than in performTask, since doing it there
            // exhibited thread safety issues.
