...
struct UjitsoCookingComputeService : public ICookingComputeService
{
    ...
    virtual PhysxCookingAsyncContext createAsyncContext(PhysxCookingAsyncContextParameters& parameters) override final
    {
        ...
        // TEMPORARY: store a pointer to the fallback service's async context in this service's async context;
        // may be removed if the ujitso service completely replaces the existing service.
        ...
        // TEMPORARY: may be removed if the ujitso service completely replaces the existing service.
