...
void PhysicsVolumeDeformableBodyInputContainer::copyInputViews()
{
    CARB_PROFILE_ZONE(0, "PhysicsVolumeDeformableBodyInputContainer::copyInputViews");

    copyVectorData(m_buildData.srcPointsInSim, m_request.volumeDeformableBodyView.srcPointsInSim);
}
