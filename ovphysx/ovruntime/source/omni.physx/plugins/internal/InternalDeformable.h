...
public:
    ...
    // Source-agnostic handles for the body / sim-mesh / skin-mesh prims; no
    // stored USD handles in runtime state.
    // The IPhysxPrivate ABI exposes these as SdfPaths (producer resolves
    // pathFor).
