...
public:
    struct AttachmentData
    {
        ...
        // Source-agnostic handle for this endpoint's prim; resolve to an
        // SdfPath on demand via AttachedStage::pathFor (no stored USD handle).
        ...
        // Handle of the rigid-body ancestor discovered by the xform walk.
...
public:
    ...
    {
        PhysXType physxType{ ePTRemoved };
        // Source-agnostic handle for this endpoint's prim; resolve via
        // AttachedStage::pathFor on demand (no stored USD handle).
        omni::physics::parse::ObjectKey key;
        usdparser::ObjectId objId{ usdparser::kInvalidObjectId };
