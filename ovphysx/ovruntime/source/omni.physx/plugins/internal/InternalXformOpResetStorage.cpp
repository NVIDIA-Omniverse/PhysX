...
void XformOpResetStorage::store(const PXR_NS::UsdGeomXformable & xformable)
{
    const std::vector<UsdGeomXformOp> xformOps = xformable.GetOrderedXformOps(&mResetXfromStack);
    resetToSize(xformOps.size());

    const SdfPath primKey = xformable.GetPrim().GetPrimPath();
...
void XformOpResetStorage::restore(PXR_NS::UsdGeomXformable & xformable, const bool purgeOrphanedTranslateOrientScaleVal) const
{
...
void XformOpResetStorage::purgeOrphanedTranslateOrientScale(PXR_NS::UsdGeomXformable & xformable) const
{
    static const PXR_NS::TfToken xformOpTranslate = PXR_NS::TfToken("xformOp:translate");
    static const PXR_NS::TfToken xformOpOrient = PXR_NS::TfToken("xformOp:orient");
    static const PXR_NS::TfToken xformOpScale = PXR_NS::TfToken("xformOp:scale");
