...
#    pragma warning(disable : 4251) // class 'pxr::TfSingleton<pxr::UsdUtilsStageCache>' needs to have dll-interface to be used by clients of class 'pxr::UsdUtilsStageCache'
...
#include <common/utilities/UsdToolsTestHelpers.h>
