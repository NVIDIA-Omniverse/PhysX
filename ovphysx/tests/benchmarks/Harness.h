...
// Verbatim from omni.physx/tests/test.benchmarks/Harness.h. Keeping this
// header byte-identical means any improvement upstream (new CLI flag, new
// field in CmdLineParameters) drops in without merge conflicts.
