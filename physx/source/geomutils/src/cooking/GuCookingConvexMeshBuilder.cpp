...
void ConvexMeshBuilder::computeSDF(const PxConvexMeshDesc& desc)
{
	...
	// results points into storage owned by this function. The caller's PxSDFDesc has to come back
	// unchanged and stay usable for a later cook. Work on a copy.
