...
bool Gu::intersectRayAABB2(const Vec3VArg minimum, const Vec3VArg maximum, 
					   const Vec3VArg ro, const Vec3VArg rd, const FloatVArg maxDist, 
					   FloatV& tnear, FloatV& tfar)
{
