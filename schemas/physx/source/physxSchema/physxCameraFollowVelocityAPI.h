...
#ifndef PHYSXSCHEMA_GENERATED_PHYSXCAMERAFOLLOWVELOCITYAPI_API_H
#define PHYSXSCHEMA_GENERATED_PHYSXCAMERAFOLLOWVELOCITYAPI_API_H
...
public:
    ...
    {
        static TfType t = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxCameraFollowVelocityAPI);
        return t;
    }
    ...
    /// \endcode
    ///
    static PhysxSchemaPhysxCameraFollowVelocityAPI Get(const UsdStagePtr &stage, const SdfPath &path)
    ...
    { return prim.CanApplyAPI(PhysxSchemaTokens->PhysxCameraFollowVelocityAPI, whyNot); }
    ...
    {
        if (prim.ApplyAPI(PhysxSchemaTokens->PhysxCameraFollowVelocityAPI)) { return PhysxSchemaPhysxCameraFollowVelocityAPI(prim); }
