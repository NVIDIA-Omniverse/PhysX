...
#ifndef PHYSXSCHEMA_GENERATED_PHYSXCONVEXHULLCOLLISIONAPI_API_H
#define PHYSXSCHEMA_GENERATED_PHYSXCONVEXHULLCOLLISIONAPI_API_H
...
public:
    ...
    {
        static TfType t = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxConvexHullCollisionAPI);
        return t;
    }
    ...
    /// \endcode
    ///
    static PhysxSchemaPhysxConvexHullCollisionAPI Get(const UsdStagePtr &stage, const SdfPath &path)
    ...
    { return prim.CanApplyAPI(PhysxSchemaTokens->PhysxConvexHullCollisionAPI, whyNot); }
    ...
    {
        if (prim.ApplyAPI(PhysxSchemaTokens->PhysxConvexHullCollisionAPI)) { return PhysxSchemaPhysxConvexHullCollisionAPI(prim); }
