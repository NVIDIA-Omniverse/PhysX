...
#ifndef PHYSXSCHEMA_GENERATED_PHYSXPHYSICSJOINTINSTANCER_API_H
#define PHYSXSCHEMA_GENERATED_PHYSXPHYSICSJOINTINSTANCER_API_H
...
public:
    ...
    {
        static TfType t = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxPhysicsJointInstancer);
        return t;
    }
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxPhysicsJointInstancer(const UsdPrim& prim=UsdPrim()) : PhysxSchemaPhysxPhysicsInstancer(prim) {}
    ...
    explicit PhysxSchemaPhysxPhysicsJointInstancer(const UsdSchemaBase& schemaObj) : PhysxSchemaPhysxPhysicsInstancer(schemaObj) {}
    ...
    /// \endcode
    ///
    static PhysxSchemaPhysxPhysicsJointInstancer Get(const UsdStagePtr &stage, const SdfPath &path)
    ...
    static PhysxSchemaPhysxPhysicsJointInstancer Define(const UsdStagePtr &stage, const SdfPath &path)
    { return PhysxSchemaPhysxPhysicsJointInstancer(stage->DefinePrim(path, PhysxSchemaTokens->PhysxPhysicsJointInstancer)); }
...
public:
    ...
    UsdAttribute CreatePhysicsLocalRot0sAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const
    {
        return UsdSchemaBase::_CreateAttr(PhysxSchemaTokens->physicsLocalRot0s,
                   SdfValueTypeNames->QuathArray, /* custom = */ false,
                   SdfVariabilityVarying, defaultValue, writeSparsely);
    }
...
public:
    ...
    { return GetPrim().CreateRelationship(PhysxSchemaTokens->physicsBody0s, /* custom = */ false); }
...
public:
    ...
    { return GetPrim().CreateRelationship(PhysxSchemaTokens->physicsBody1s, /* custom = */ false); }
