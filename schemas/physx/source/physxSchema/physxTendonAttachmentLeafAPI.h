...
#ifndef PHYSXSCHEMA_GENERATED_PHYSXTENDONATTACHMENTLEAFAPI_API_H
#define PHYSXSCHEMA_GENERATED_PHYSXTENDONATTACHMENTLEAFAPI_API_H
...
public:
    ...
    {
        static TfType t = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxTendonAttachmentLeafAPI);
        return t;
    }
    ...
    static bool IsPhysxTendonAttachmentLeafAPIPath(const SdfPath &path, TfToken *name)
    {
    ...
    static PhysxSchemaPhysxTendonAttachmentLeafAPI Get(const UsdPrim &prim, const TfToken &name)
    ...
    /// \endcode
    ///
    static PhysxSchemaPhysxTendonAttachmentLeafAPI Get(const UsdStagePtr &stage, const SdfPath &path)
    {
        if (!stage) {
    ...
    /// given \p prim.
    static std::vector<PhysxSchemaPhysxTendonAttachmentLeafAPI> GetAll(const UsdPrim &prim)
    {
        std::vector<PhysxSchemaPhysxTendonAttachmentLeafAPI> schemas;
        const TfType &type = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxTendonAttachmentLeafAPI);
    ...
    { return prim.CanApplyAPI(PhysxSchemaTokens->PhysxTendonAttachmentLeafAPI, name, whyNot); }
    ...
    {
        if (prim.ApplyAPI(PhysxSchemaTokens->PhysxTendonAttachmentLeafAPI, name)) { return PhysxSchemaPhysxTendonAttachmentLeafAPI(prim, name); }
        return PhysxSchemaPhysxTendonAttachmentLeafAPI();
    }
