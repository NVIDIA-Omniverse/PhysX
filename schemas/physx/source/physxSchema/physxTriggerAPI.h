...
#ifndef PHYSXSCHEMA_GENERATED_PHYSXTRIGGERAPI_API_H
#define PHYSXSCHEMA_GENERATED_PHYSXTRIGGERAPI_API_H
...
public:
    ...
    {
        static TfType t = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxTriggerAPI);
        return t;
    }
    ...
    /// \endcode
    ///
    static PhysxSchemaPhysxTriggerAPI Get(const UsdStagePtr &stage, const SdfPath &path)
    ...
    { return prim.CanApplyAPI(PhysxSchemaTokens->PhysxTriggerAPI, whyNot); }
    ...
    {
        if (prim.ApplyAPI(PhysxSchemaTokens->PhysxTriggerAPI)) { return PhysxSchemaPhysxTriggerAPI(prim); }
