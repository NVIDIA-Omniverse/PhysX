...
#ifndef PHYSXSCHEMA_GENERATED_PHYSXVEHICLEDRIVESTANDARDAPI_API_H
#define PHYSXSCHEMA_GENERATED_PHYSXVEHICLEDRIVESTANDARDAPI_API_H
...
public:
    ...
    {
        static TfType t = UsdSchemaRegistry::GetTypeFromSchemaTypeName(PhysxSchemaTokens->PhysxVehicleDriveStandardAPI);
        return t;
    }
    ...
    /// \endcode
    ///
    static PhysxSchemaPhysxVehicleDriveStandardAPI Get(const UsdStagePtr &stage, const SdfPath &path)
    ...
    { return prim.CanApplyAPI(PhysxSchemaTokens->PhysxVehicleDriveStandardAPI, whyNot); }
    ...
    {
        if (prim.ApplyAPI(PhysxSchemaTokens->PhysxVehicleDriveStandardAPI)) { return PhysxSchemaPhysxVehicleDriveStandardAPI(prim); }
...
public:
    ...
    { return GetPrim().CreateRelationship(PhysxSchemaTokens->physxVehicleDriveStandardEngine, /* custom = */ false); }
...
public:
    ...
    { return GetPrim().CreateRelationship(PhysxSchemaTokens->physxVehicleDriveStandardGears, /* custom = */ false); }
...
public:
    ...
    { return GetPrim().CreateRelationship(PhysxSchemaTokens->physxVehicleDriveStandardAutoGearBox, /* custom = */ false); }
...
public:
    ...
    { return GetPrim().CreateRelationship(PhysxSchemaTokens->physxVehicleDriveStandardClutch, /* custom = */ false); }
